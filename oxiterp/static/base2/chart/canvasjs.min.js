/*
 CanvasJS HTML5 & JavaScript Charts - v3.2 Beta 1 - https://canvasjs.com/
...
(function () {
    ...
    function Aa(k) {
        k.roundRect = function (k, v, t, s, qa, D, w, F) {
            w && (this.fillStyle = w);
            ...
            this.beginPath();
            this.moveTo(k + qa, v);
            this.lineTo(k + t - qa, v);
            this.quadraticCurveTo(k + t, v, k + t, v + qa);
            this.lineTo(k + t,
                v + s - qa);
            this.quadraticCurveTo(k + t, v + s, k + t - qa, v + s);
            this.lineTo(k + qa, v + s);
            this.quadraticCurveTo(k, v + s, k, v + s - qa);
            this.lineTo(k, v + qa);
    ...
    function cb(k, m) {
        var v = this.length >>> 0, t = Number(m) || 0, t = 0 > t ? Math.ceil(t) :
            Math.floor(t);
        for (0 > t && (t += v); t < v; t++) if (t in this && this[t] === k) return t;
        return -1
    }
    ...
    function N(k, m) {
        ...
        }[k || "solid"]) for (var t = 0; t < v.length; t++) v[t] *= m; else v = [];
        return v
    }

    function V(k, m, v, s, w) {
        s = s || [];
        w = t(w) ? eb ? {passive: !1, capture: !1} : !1 : w;
        s.push([k, m, v, w]);
    ...
    function fb(k) {
        if (k._menuButton) k.exportEnabled ? Ja(k._menuButton) : ta(k._menuButton); else if (k.exportEnabled && s) {
            var m = !1;
            ...
            V(k._menuButton, "mouseover", function () {
                m || (oa(k, k._menuButton, {
                    backgroundColor: k.toolbar.backgroundColorOnHover,
                    color: k.toolbar.fontColorOnHover
                }), 0 >= navigator.userAgent.search("MSIE") && oa(k, k._menuButton.childNodes[0], {
                    WebkitFilter: "invert(100%)",
                    filter: "invert(100%)"
                }))
            }, k.allDOMEventHandlers, !0);
            V(k._menuButton, "mouseout", function () {
                m || (oa(k, k._menuButton, {backgroundColor: k.toolbar.backgroundColor, color: k.toolbar.fontColor}),
                0 >= navigator.userAgent.search("MSIE") && oa(k, k._menuButton.childNodes[0], {
    ...
    function Ka(k, m, v) {
        if (s && Ya) {
            ...
            La = t.webkitBackingStorePixelRatio || t.mozBackingStorePixelRatio || t.msBackingStorePixelRatio || t.oBackingStorePixelRatio || t.backingStorePixelRatio || 1;
            ga = Pa / La;
            k.width = m * ga;
            k.height = v * ga;
            Pa !== La && (k.style.width = m + "px", k.style.height = v + "px", t.scale(ga, ga))
    ...
    function oa(k, m, v) {
        for (var t in v) m.style[t] = v[t]
    }

    function ua(k, m, v) {
        m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor, m.style.color = k.toolbar.fontColor, m.style.border = "none", oa(k, m, {
        ...
        v && (m.setAttribute("state", v), m.setAttribute("type", "button"), oa(k, m, {
            padding: "5px 12px",
            cursor: "pointer",
            "float": "left",
            width: "40px",
    ...
    function W(k, m, v, s, w) {
        ...
        k = {};
        this.theme && t(this.parent) && t(m) && t(s) ? k = t(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === s ? k = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (s = Math.min(this.parent.themeOptions[m].length - 1, s), k = this.parent.themeOptions[m][s]));
        this.themeOptions = k;
        this.options = v ? v : {_isPlaceholder: !0};
        this.setOptions(this.options, k)
    }

    function Ca(k, m, v, t, s) {
        "undefined" ===
        typeof s && (s = 0);
        this._padding = s;
        this._x1 = k;
    ...
    function xa(k, m) {
        ...
        if (t(this.options.margin) && k.options.subtitles) for (var v = k.options.subtitles, s = 0; s < v.length; s++) if ((t(v[s].horizontalAlign) && "center" === this.horizontalAlign || v[s].horizontalAlign === this.horizontalAlign) && (t(v[s].verticalAlign) && "top" === this.verticalAlign || v[s].verticalAlign === this.verticalAlign) && !v[s].dockInsidePlotArea === !this.dockInsidePlotArea) {
            this.margin = 0;
            break
        }
    ...
    var Fa = !1, J = {}, s = !!document.createElement("canvas").getContext, pa = {
        Chart: {
            width: 300,
            height: 200,
            zoomEnabled: !1,
    ...
    }, Ia = {en: {}}, w = s ? "Trebuchet MS, Helvetica, sans-serif" :
        "Arial", Da = s ? "Impact, Charcoal, sans-serif" : "Arial", ya = {
        colorSet1: "#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),
        colorSet2: "#fd9116 #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),
    ...
    var U = 20, F = 14, Ta = {
        ...
        axisX2: [{
            ...
            crosshair: {
                labelFontFamily: w, labelFontSize: F, labelFontColor: "#EEEEEE",
        ...
        axisY: [{
            ...
            gridColor: I,
            stripLines: [{
                labelFontFamily: w, labelFontSize: F, labelFontColor: "#FF7300",
    ...
    var U = 20, F = 14, Za = {
        colorSet: "colorSet2",
        title: {fontFamily: w, fontSize: 33, fontColor: "#ffffff", fontWeight: "bold", verticalAlign: "top", margin: 5},
        subtitles: [{
            fontFamily: w,
            fontSize: F,
            fontColor: "#ffffff",
        ...
        axisY: [{
            ...
            crosshair: {
                ...
                labelBackgroundColor: "white", color: "white", thickness: 1, lineDashType: "dot"
            },
            scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}
        }],
        axisY2: [{
    ...
    var eb = function () {
            ...
            return function (F, N, M) {
                var I = M ? M.days : m, P = M ? M.months : t, V = M ? M.shortDays : v, Q = M ? M.shortMonths : s;
                M = "";
                var J = !1;
                ...
                M = J ? "getUTC" : "get";
                var W = F[M + "Date"](), L = F[M + "Day"](), X = F[M + "Month"](), a = F[M + "FullYear"](),
                ...
                return M = N.replace(k, function (p) {
                    switch (p) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return J ? "UTC" : (String(F).match(w) || [""]).pop().replace(D, "");
                        case "z":
            ...
            m = String(m);
            var D = 1, F = v = "", N = -1, M = [], I = [], P = 0, J = 0, V = 0, Q = !1, W = 0,
                F = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            m = null;
            ...
            Q && (m = Math.floor(k), F = -Math.floor(Math.log(k) / Math.LN10 + 1), W = 0 === k ? 0 : 0 === m ? -(P + F) : String(m).length - P, D /= Math.pow(10, W));
            0 > N && (N = L);
            D = (k * D).toFixed(J);
            m = D.split(".");
            D = (m[0] + "").split("");
            k = (m[1] + "").split("");
            D && "0" === D[0] && D.shift();
            for (Q = F = L = J = N = 0; 0 < M.length;) if (m = M.pop(), "#" === m || "0" === m) if (N++, N === P) {
                var X =
                    D, D = [];
                if ("0" === m) for (m = P - J - (X ? X.length : 0); 0 < m;) X.unshift("0"), m--;
                for (; 0 < X.length;) v = X.pop() + v, Q++, 0 === Q % F && (L === V && 0 < X.length) && (v = w + v)
            } else 0 < D.length ? (v = D.pop() + v, J++, Q++) : "0" === m && (v = "0" + v, J++, Q++), 0 === Q % F && (L === V && 0 < D.length) && (v = w + v); else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, F = Q, Q = 0, 0 < D.length && (v = w + v)) : v = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + v : m + v : (m = 0 > W ? m.replace("+", "").replace("-",
                "") : m.replace("-", ""), v += m.replace(/[0]+/, function (a) {
                return $(W, a.length)
            }));
            w = "";
            for (M = !1; 0 < I.length;) m = I.shift(), "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(), M = !0) : "0" === m && (w += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? w += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? w += m : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function (a) {
                return $(W, a.length)
            }));
            v += (M ? s : "") + w;
            return t ? "-" + v : v
            ...
            return {x: m, y: v}
        }, Ya = !0, Pa = window.devicePixelRatio || 1, La = 1, ga = Ya ? Pa / La : 1,
        ca = function (k, m, v, t, s, w, D, F, N, M, Q, P, I) {
            "undefined" === typeof I && (I = 1);
            D = D || 0;
            F = F || "black";
            var J = 15 < t - m && 15 < s - v ? 8 : 0.35 * Math.min(t - m, s - v);
            k.beginPath();
            k.moveTo(m, v);
            k.save();
            k.fillStyle = w;
            k.globalAlpha =
                I;
            k.fillRect(m, v, t - m, s - v);
            k.globalAlpha = 1;
            0 < D && (I = 0 === D % 2 ? 0 : 0.5, k.beginPath(), k.lineWidth = D, k.strokeStyle = F, k.moveTo(m, v), k.rect(m - I, v - I, t - m + 2 * I, s - v + 2 * I), k.stroke());
            k.restore();
            !0 === N && (k.save(), k.beginPath(), k.moveTo(m, v), k.lineTo(m + J, v + J), k.lineTo(t - J, v + J), k.lineTo(t, v), k.closePath(), D = k.createLinearGradient((t + m) / 2, v + J, (t + m) / 2, v), D.addColorStop(0, w), D.addColorStop(1, "rgba(255, 255, 255, .4)"), k.fillStyle = D, k.fill(), k.restore());
            !0 === M && (k.save(), k.beginPath(), k.moveTo(m, s), k.lineTo(m + J, s - J), k.lineTo(t -
                J, s - J), k.lineTo(t, s), k.closePath(), D = k.createLinearGradient((t + m) / 2, s - J, (t + m) / 2, s), D.addColorStop(0, w), D.addColorStop(1, "rgba(255, 255, 255, .4)"), k.fillStyle = D, k.fill(), k.restore());
            !0 === Q && (k.save(), k.beginPath(), k.moveTo(m, v), k.lineTo(m + J, v + J), k.lineTo(m + J, s - J), k.lineTo(m, s), k.closePath(), D = k.createLinearGradient(m + J, (s + v) / 2, m, (s + v) / 2), D.addColorStop(0, w), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, k.fill(), k.restore());
            !0 === P && (k.save(), k.beginPath(), k.moveTo(t, v), k.lineTo(t - J,
                v + J), k.lineTo(t - J, s - J), k.lineTo(t, s), D = k.createLinearGradient(t - J, (s + v) / 2, t, (s + v) / 2), D.addColorStop(0, w), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, D.addColorStop(0, w), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, k.fill(), k.closePath(), k.restore())
        }, Y = function (k) {
            for (var m = "", t = 0; t < k.length; t++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(t));
            return m
        },
        ...
        hb = ab && -1 === window[Y("mnb`uhno")].href.indexOf(Y("gheemd")), ib = {
    ...
    W.prototype.setOptions = function (k, m) {
        if (pa[this._defaultsKey]) {
            var t = pa[this._defaultsKey], s;
            for (s in t) "publicProperties" !== s && t.hasOwnProperty(s) && (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : t[s])
    ...
    W.prototype.set = function (k, m, t) {
    ...
    W.prototype.addTo = function (k, m, t, s) {
    ...
    W.prototype.createUserOptions = function (k) {
        ...
        this.parent.createUserOptions(), this.isOptionsInArray) {
            ...
            var m = this.parent.options[this.optionsName], t = m.length;
            this.options._isPlaceholder || (Ba(m), t = m.indexOf(this.options));
            this.options = "undefined" === typeof k ? {} : k;
            m[t] = this.options
        } else this.options = "undefined" === typeof k ? {} : k, k = this.parent.options, this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (t = m.charAt(0).toLowerCase(), 1 < m.length && (t = t.concat(m.slice(1))),
            m = t) : m = void 0, k[m] = this.options
    };
    ...
    W.prototype.updateOption = function (k) {
        ...
        var m = pa[this._defaultsKey], s = {}, w = this[k], F = this._themeOptionsKey,
            J = this._index;
        this.theme && t(this.parent) && t(F) && t(J) ? s = t(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[F]) && (null === J ? s = this.parent.themeOptions[F] : 0 < this.parent.themeOptions[F].length && (s = Math.min(this.parent.themeOptions[F].length - 1, J), s = this.parent.themeOptions[F][s]));
        this.themeOptions = s;
    ...
    W.prototype.addEventListener = function (k, m, t) {
        k && m && (this._eventListeners[k] =
            this._eventListeners[k] || [], this._eventListeners[k].push({context: t || this, eventHandler: m}))
    };
    W.prototype.removeEventListener = function (k, m) {
        if (k && m && this._eventListeners[k]) for (var t = this._eventListeners[k], s = 0; s < t.length; s++) if (t[s].eventHandler === m) {
            t[s].splice(s, 1);
            break
        }
    };
    ...
    ia.prototype._initialize = function () {
        t(this.padding) || "object" !== typeof this.padding ? this.topPadding =
            this.rightPadding = this.bottomPadding = this.leftPadding = Number(this.padding) | 0 : (this.topPadding = t(this.padding.top) ? 0 : Number(this.padding.top) | 0, this.rightPadding = t(this.padding.right) ? 0 : Number(this.padding.right) | 0, this.bottomPadding = t(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0, this.leftPadding = t(this.padding.left) ? 0 : Number(this.padding.left) | 0)
    };
    ia.prototype.render = function (k) {
        if (0 !== this.fontSize) {
            ...
            var s = 0, w = this.topPadding, F = null;
            this.ctx.roundRect || Aa(this.ctx);
            (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(0, t, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor);
            this.ctx.fillStyle = this.fontColor;
            for (t = 0; t < this._wrappedText.lines.length; t++) {
                F =
                    this._wrappedText.lines[t];
                if ("right" === this.horizontalAlign || "right" === this.textAlign) s = this.width - F.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) s = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) s = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding;
                this.ctx.fillText(F.text, s, w);
                w += F.height
            }
            this.ctx.font = m;
            k && this.ctx.restore()
    ...
    ia.prototype._getLineWithWidth = function (k, m, t) {
        k = String(k);
        if (!k) return {text: "", width: 0};
        var s = t = 0, w = k.length - 1, F = Infinity;
        for (this.ctx.font = this._getFontString(); s <= w;) {
            var F = Math.floor((s + w) / 2), D = k.substr(0, F + 1);
            t = this.ctx.measureText(D).width;
            if (t < m) s = F + 1; else if (t > m) w = F - 1; else break
        }
        t > m && 1 < D.length && (D = D.substr(0, D.length - 1), t = this.ctx.measureText(D).width);
        m = !0;
        if (D.length === k.length || " " === k[D.length]) m = !1;
        m && (k = D.split(" "), 1 < k.length && k.pop(), D = k.join(" "), t = this.ctx.measureText(D).width);
        return {text: D, width: t}
    };
    ia.prototype._wrapText = function () {
        var k = new String(Ea(String(this.text))), m = [], t = this.ctx.font, s = 0, w = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) w = s = 0; else for (; 0 < k.length;) {
            ...
            m.push(D);
            var J = w, w = Math.max(w, D.width), s = s + D.height, k = Ea(k.slice(D.text.length, k.length));
            F && s > F && (D = m.pop(), s -= D.height, w = J)
        }
    ...
    xa.prototype.setLayout = function () {
        if (this.text) {
            var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = k.layoutManager.getFreeSpace(),
                s = m.x1, w = m.y1, F = 0, J = 0,
                D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, I;
            ...
            var M;
            t(this.padding) || "number" !== typeof this.padding ? t(this.padding) || "object" !==
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = m.y1 + 2, I = "top") : "bottom" === this.verticalAlign && (w = m.y2 - 2 - M.height, I = "bottom"), "left" === this.horizontalAlign ? s = m.x1 + 2 : "center" === this.horizontalAlign ? s = m.x1 + m.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (s = m.x2 - 2 - M.width - D), N = this.horizontalAlign,
                this.width = M.width, this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (s = m.x1 + 2, w = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2), F = -90, I = "left", this.width = M.height, this.height = M.width) : "right" === this.horizontalAlign ? (s = m.x2 - 2, w = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2), F = 90, I = "right", this.width = M.height, this.height = M.width) : "center" === this.horizontalAlign && (w = k.y1 + (k.height / 2 - M.height / 2), s = k.x1 + (k.width / 2 - M.width / 2), I = "center", this.width = M.width, this.height = M.height), N = "center");
            J.x =
                s;
            J.y = w;
            J.angle = F;
    ...
    w = Na.Chart = function () {
        ...
        function m(a, d, c) {
            d = d || {};
            t(c) ? (this.predefinedThemes = $a, this.optionsName =
            ...
            this.theme = t(d.theme) || t(this.predefinedThemes[d.theme]) ? "light1" : d.theme;
        ...
        function w(a, d, c, b, e, f, p, l, A, h) {
            var n = 0;
            ...
            var n = 1 === Math.round(p.thickness) % 2 ? 0.5 : 0, r = 1 === Math.round(l.thickness) % 2 ? 0.5 : 0;
            a.save();
            a.globalAlpha = h;
        ...
        function U(a, d, c, b, e, f) {
            ...
            this.fillOpacity = t(c.fillOpacity) ? f.fillOpacity : this.fillOpacity;
            this.lineThickness = t(c.lineThickness) ? f.lineThickness : this.lineThickness;
            ...
            !t(this.startValue) && this.startValue.getTime && (this.startValue = this.startValue.getTime());
            !t(this.endValue) && this.endValue.getTime && (this.endValue =
        ...
        m.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled =
                    !1), Ja(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))
        ...
        m.prototype._initialize = function () {
            this.isNavigator = t(this.parent) || t(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ? !1 : !0;
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++) if (a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
                    ...
                    "error" === b.type && (b.linkedDataSeriesIndex = t(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex ||
        ...
        m.prototype.setLayout = function () {
            ...
            c ? (Ja(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor, this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor, this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness :
            ...
            this.subtitles = [];
            if (this.options.subtitles) for (d = 0; d < this.options.subtitles.length; d++) c = new Ga(this, this.options.subtitles[d],
        ...
        m.prototype.renderElements =
            function () {
                ...
                for (d = 0; d < this.plotInfo.plotTypes.length; d++) for (var f = this.plotInfo.plotTypes[d], p = 0; p < f.plotUnits.length; p++) {
                    var l = f.plotUnits[p], A = null;
                    l.targetCanvas = null;
                    ...
                    "line" === l.type ? A = this.renderLine(l) : "stepLine" === l.type ? A = this.renderStepLine(l) :
                        "spline" === l.type ? A = this.renderSpline(l) : "column" === l.type ? A = this.renderColumn(l) : "bar" === l.type ? A = this.renderBar(l) : "area" === l.type ? A = this.renderArea(l) : "stepArea" === l.type ? A = this.renderStepArea(l) : "splineArea" === l.type ? A = this.renderSplineArea(l) : "stackedColumn" === l.type ? A = this.renderStackedColumn(l) : "stackedColumn100" === l.type ? A = this.renderStackedColumn100(l) : "stackedBar" === l.type ? A = this.renderStackedBar(l) : "stackedBar100" === l.type ? A = this.renderStackedBar100(l) : "stackedArea" === l.type ? A = this.renderStackedArea(l) :
                            "stackedArea100" === l.type ? A = this.renderStackedArea100(l) : "bubble" === l.type ? A = A = this.renderBubble(l) : "scatter" === l.type ? A = this.renderScatter(l) : "pie" === l.type ? this.renderPie(l) : "doughnut" === l.type ? this.renderPie(l) : "funnel" === l.type ? A = this.renderFunnel(l) : "pyramid" === l.type ? A = this.renderFunnel(l) : "candlestick" === l.type ? A = this.renderCandlestick(l) : "ohlc" === l.type ? A = this.renderCandlestick(l) : "rangeColumn" === l.type ? A = this.renderRangeColumn(l) : "error" === l.type ? A = this.renderError(l) : "rangeBar" === l.type ?
                                A = this.renderRangeBar(l) : "rangeArea" === l.type ? A = this.renderRangeArea(l) : "rangeSplineArea" === l.type ? A = this.renderRangeSplineArea(l) : "waterfall" === l.type ? A = this.renderWaterfall(l) : "boxAndWhisker" === l.type && (A = this.renderBoxAndWhisker(l));
                ...
                if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function (a) {
                    ...
                    if (n._breaksCanvas) if (s) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height); else for (h = 0; h < n._axes.length; h++) n._axes[h].createMask();
        ...
        m.prototype.categoriseDataSeries = function () {
            for (var a = "", d = 0; d < this.data.length; d++) if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
                for (var c =
                    null, b = !1, e = null, f = !1, p = 0; p < this.plotInfo.plotTypes.length; p++) if (this.plotInfo.plotTypes[p].type === a.type) {
                    b = !0;
                    c = this.plotInfo.plotTypes[p];
                    break
                }
                b || (c = {type: a.type, totalDataSeries: 0, plotUnits: []}, this.plotInfo.plotTypes.push(c));
                for (p = 0; p < c.plotUnits.length; p++) if (c.plotUnits[p].axisYType === a.axisYType && c.plotUnits[p].axisXType === a.axisXType && c.plotUnits[p].axisYIndex === a.axisYIndex && c.plotUnits[p].axisXIndex === a.axisXIndex) {
                    f = !0;
                    e = c.plotUnits[p];
                    break
                }
        ...
        m.prototype._processMultiseriesPlotUnit = function (a) {
            if (a.dataSeriesIndexes &&
                !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var l = this.data[a.dataSeriesIndexes[p]], A = 0, h = !1, n = !1, r;
                if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ?
                    0 : -Infinity,
                ...
                for (A = 0; A < l.dataPoints.length; A++) {
                    ...
                    l.dataPoints[A].x.getTime ?
                        (f = !0, b = l.dataPoints[A].x.getTime()) : b = l.dataPoints[A].x;
                    e = l.dataPoints[A].y;
                    b < c.min && (c.min = b);
                    b > c.max && (c.max = b);
                    ...
                    if (0 < A) {
                        if (a.axisX.logarithmic) {
                            var z = b / l.dataPoints[A - 1].x;
                            1 > z && (z = 1 / z);
                            c.minDiff > z && 1 !== z && (c.minDiff = z)
                        } else z = b - l.dataPoints[A - 1].x, 0 > z && (z *= -1), c.minDiff > z && 0 !== z && (c.minDiff = z);
                        null !== e && null !== l.dataPoints[A - 1].y && (a.axisY.logarithmic ? (z = e / l.dataPoints[A - 1].y, 1 > z && (z = 1 / z), d.minDiff > z && 1 !== z && (d.minDiff =
                            z)) : (z = e - l.dataPoints[A - 1].y, 0 > z && (z *= -1), d.minDiff > z && 0 !== z && (d.minDiff = z)))
                    }
        ...
        m.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], l = [], A = Infinity, h = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var r = this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, z = !1, k;
                    if ("normal" === r.axisPlacement || "xySwapped" === r.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
                    ...
                    for (q = 0; q < r.dataPoints.length; q++) {
                        ...
                        e = t(r.dataPoints[q].y) ? 0 : r.dataPoints[q].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        if (0 < q) {
                            if (a.axisX.logarithmic) {
                            ...
                            null !== e && null !== r.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (x = e / r.dataPoints[q -
                            1].y, 1 > x && (x = 1 / x), d.minDiff > x && 1 !== x && (d.minDiff = x)) : (x = e - r.dataPoints[q - 1].y, 0 > x && (x *= -1), d.minDiff > x && 0 !== x && (d.minDiff = x)))
                        }
                        if (b < m && !g) null !== r.dataPoints[q].y && (k = b); else {
                            ...
                            if (b > u && !z) z = !0; else if (b > u && z) continue;
                            r.dataPoints[q].label && (a.axisX.labels[b] = r.dataPoints[q].label);
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === r.dataPoints[q].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ?
                                p[b] ? p[b] += e : (p[b] = e, A = Math.min(e, A)) : l[b] ? l[b] += e : (l[b] = e, h = Math.max(e, h)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, p), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, l)) : (d.dataPointYPositiveSums = p, d.dataPointYNegativeSums = l));
                    r.axisX.valueType = r.xValueType = f ? "dateTime" : "number"
                }
                for (q in p) p.hasOwnProperty(q) && !isNaN(q) && (a = p[q], a <
                d.min && (d.min = Math.min(a, A)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, A)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in l) l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))))
            }
        };
        m.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d =
                    a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, l = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var n = this.data[a.dataSeriesIndexes[h]], r = 0, q = !1, g = !1, z;
                    if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var k = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                    ...
                    for (r = 0; r < n.dataPoints.length; r++) {
                        ...
                        e = t(n.dataPoints[r].y) ? null : n.dataPoints[r].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        if (0 < r) {
                            if (a.axisX.logarithmic) {
                                var u = b / n.dataPoints[r - 1].x;
                                1 > u && (u = 1 / u);
                                c.minDiff > u && 1 !== u && (c.minDiff = u)
                            } else u = b - n.dataPoints[r - 1].x, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u);
                            t(e) || null === n.dataPoints[r - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / n.dataPoints[r - 1].y, 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - n.dataPoints[r - 1].y, 0 > u && (u *= -1), d.minDiff > u && 0 !== u && (d.minDiff = u)))
                        }
                        if (b < k && !q) null !== e && (z = b);
                        else {
                            if (!q && (q = !0, 0 < r)) {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && z < b && (c.viewPortMin = z) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ? p = !0 : 0 > e && (l = !0), A[b] = A[b] ? A[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
                    n.axisX.valueType = n.xValueType = f ? "dateTime" : "number"
                }
                a.axisY.logarithmic ? (d.max = t(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase,
                    -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = t(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && !l ? (d.max = t(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = t(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && l ? (d.max = t(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = t(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !p && l && (d.max = t(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = t(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                d.viewPortMin = d.min;
                d.viewPortMax =
                    d.max;
                a.dataPointYSums = A
        ...
        m.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, l = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                var h = this.data[a.dataSeriesIndexes[A]], n = 0, r = !1, q = !1, g, z, k;
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum :
                ...
                for (n = 0; n < h.dataPoints.length; n++) {
                    ...
                    if ((e = h.dataPoints[n].y) && e.length) {
                        ...
                        z = !0;
                        for (var x = 0; x < e.length; x++) null === e.k && (z = !1);
                        z && (r || (k = g), g = b)
                    }
                    b < c.min && (c.min = b);
                    b > c.max && (c.max = b);
                    f < d.min && (d.min = f);
                    p > d.max && (d.max = p);
                    0 < n && (a.axisX.logarithmic ? (z = b / h.dataPoints[n - 1].x, 1 > z && (z = 1 / z), c.minDiff > z && 1 !== z && (c.minDiff = z)) : (z = b - h.dataPoints[n - 1].x, 0 > z && (z *= -1), c.minDiff >
                    z && 0 !== z && (c.minDiff = z)), e && (null !== e[0] && h.dataPoints[n - 1].y && null !== h.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (z = e[0] / h.dataPoints[n - 1].y[0], 1 > z && (z = 1 / z), d.minDiff > z && 1 !== z && (d.minDiff = z)) : (z = e[0] - h.dataPoints[n - 1].y[0], 0 > z && (z *= -1), d.minDiff > z && 0 !== z && (d.minDiff = z))));
                    if (!(b < m) || r) {
                        if (!r && (r = !0, 0 < n)) {
                            n -= 2;
                            g = k;
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (l.dataPoints[A].x && l.dataPoints[A].x.getTime || "dateTime" === l.xValueType) f = !0;
                for (A = 0; A < l.dataPoints.length; A++) "undefined" !== typeof l.dataPoints[A].isCumulativeSum && !0 === l.dataPoints[A].isCumulativeSum ? (l.dataPointEOs[A].cumulativeSumYStartValue = 0, l.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum, l.dataPoints[A].y = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum) :
                    "undefined" !== typeof l.dataPoints[A].isIntermediateSum && !0 === l.dataPoints[A].isIntermediateSum ? (l.dataPointEOs[A].cumulativeSumYStartValue = r, l.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum, l.dataPoints[A].y = 0 === A ? 0 : b, r = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum, b = 0) : (e = "number" !== typeof l.dataPoints[A].y ? 0 : l.dataPoints[A].y, l.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum, l.dataPointEOs[A].cumulativeSum = 0 === A ? e : l.dataPointEOs[A - 1].cumulativeSum +
                        e, b += e);
                for (A = 0; A < l.dataPoints.length; A++) if ("undefined" === typeof l.dataPoints[A].x && (l.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), l.dataPoints[A].x.getTime ? (f = !0, b = l.dataPoints[A].x.getTime()) : b = l.dataPoints[A].x, e = l.dataPoints[A].y, b < c.min && (c.min = b), b > c.max && (c.max = b), l.dataPointEOs[A].cumulativeSum < d.min && (d.min = l.dataPointEOs[A].cumulativeSum), l.dataPointEOs[A].cumulativeSum > d.max && (d.max = l.dataPointEOs[A].cumulativeSum), 0 < A && (a.axisX.logarithmic ? (r = b / l.dataPoints[A - 1].x, 1 > r && (r = 1 / r), c.minDiff >
                r && 1 !== r && (c.minDiff = r)) : (r = b - l.dataPoints[A - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), null !== e && null !== l.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = l.dataPointEOs[A].cumulativeSum / l.dataPointEOs[A - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = l.dataPointEOs[A].cumulativeSum - l.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || h) {
                    if (!h && (h = !0, 0 < A)) {
                        A -= 2;
                        continue
                    }
                    if (b > g && !n) n = !0; else if (b > g && n) continue;
                    l.dataPoints[A].label && (a.axisX.labels[b] =
        ...
        m.prototype.calculateAutoBreaks = function () {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, p = f.max, l = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, r = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                        var k = e.data[a.dataSeriesIndexes[A]];
                        if (!(4 > k.dataPoints.length)) for (r = 0; r < k.dataPoints.length; r++) if (b && (q = (p + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[r].x.getTime ? k.dataPoints[r].x.getTime() :
                            k.dataPoints[r].x, q = Math.floor((g - h) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                            var m = (n + 1 - l) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                            if ((g = "waterfall" === a.type ? k.dataPointEOs[r].cumulativeSum : k.dataPoints[r].y) && g.length) for (var s = 0; s < g.length; s++) q = Math.floor((g[s] - l) / m), g[s] < d[q].min && (d[q].min = g[s]), g[s] > d[q].max && (d[q].max = g[s]); else t(g) || (q = Math.floor((g - l) / m), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g))
                        }
                    }
                }
            }
            ...
            function c(a) {
                if (a.dataSeriesIndexes &&
                    !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var l = e.data[a.dataSeriesIndexes[p]];
                    if (!(4 > l.dataPoints.length)) for (h = 0; h < l.dataPoints.length; h++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = l.dataPoints[h].x.getTime ? l.dataPoints[h].x.getTime() : l.dataPoints[h].x, g = Math.floor((b -
                        c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b)
                }
            }
            ...
            for (var b, e = this, f = !1, p = 0; p < this._axes.length; p++) if (this._axes[p].scaleBreaks && this._axes[p].scaleBreaks.autoCalculate && 1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks) {
                ...
                for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) || 10, 10); l++) this._axes[p].dataInfo._dataRanges.push({
                    min: Infinity,
                    max: -Infinity
                })
            }
            if (f) {
                for (p = 0; p < this.plotInfo.plotTypes.length; p++) for (f = this.plotInfo.plotTypes[p],
                ...
                for (p = 0; p < this._axes.length; p++) if (this._axes[p].dataInfo._dataRanges) {
                    var A =
                        this._axes[p].dataInfo.min;
                    ...
                    if (this._axes[p].dataInfo.dataPointYPositiveSums) {
                        ...
                        n = h;
                        for (l in q) if (q.hasOwnProperty(l) && !isNaN(l) && (r = q[l], !t(r))) {
                    ...
                    if (this._axes[p].dataInfo.dataPointYNegativeSums) {
                        ...
                        n = h;
                        for (l in q) q.hasOwnProperty(l) && !isNaN(l) && (r = -1 * q[l], t(r) || (g = Math.floor((r - A) / b), r < n[g].min && (n[g].min = r), r > n[g].max && (n[g].max = r)));
                        delete this._axes[p].dataInfo.dataPointYNegativeSums
                    }
                    for (l = 0; l < h.length - 1; l++) if (n = h[l].max, isFinite(n)) for (; l < h.length - 1;) if (A = h[l + 1].min, isFinite(A)) {
                        r = A - n;
                        r > b && f.push({diff: r, start: n, end: A});
                        break
                    } else l++;
                    if (this._axes[p].scaleBreaks.customBreaks) for (l = 0; l < this._axes[p].scaleBreaks.customBreaks.length; l++) for (b =
                                                                                                                                             0; b < f.length; b++) if (this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue || this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue || f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].startValue && this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].end || f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue && this._axes[p].scaleBreaks.customBreaks[l].endValue <=
                        f[b].end) f.splice(b, 1), b--;
                    f.sort(function (a, b) {
                        return b.diff - a.diff
                    });
                    for (l = 0; l < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); l++) b = a(f[l].start, f[l].end, this._axes[p].logarithmic ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min, this._axes[p].logarithmic), this._axes[p].scaleBreaks.autoBreaks.push(new U(this, "autoBreaks", b, l, ++this._eventManager.lastObjectId, this._axes[p].scaleBreaks)), this._axes[p].scaleBreaks._appliedBreaks.push(this._axes[p].scaleBreaks.autoBreaks[this._axes[p].scaleBreaks.autoBreaks.length -
                    1]);
        ...
        m.prototype.getObjectAtXY = function (a, d, c) {
            var b = null;
            if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (s) b = Xa(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
        ...
        m.prototype._touchEventHandler = function (a) {
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    e.time = new Date;
                    try {
                        var p = e.y - this._lastTouchData.y, f = e.time - this._lastTouchData.time;
        ...
        m.prototype._dispatchRangeEvent = function (a, d) {
            ...
            for (var e = 0; e < b.length; e++) if (t(c[b[e]]) && (c[b[e]] = []), "axisY" === b[e]) for (var f = 0; f < this.axisY.length; f++) c[b[e]].push({
        ...
        m.prototype._mouseEventHandler = function (a) {
            ...
            m.capturedEventParam && (b = m.capturedEventParam, "mouseup" === c && (m.capturedEventParam = null, b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup",
                b.chart._mouseEventHandler, !1)), b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? a.target !== b.chart.overlaidCanvas && s || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
        ...
        m.prototype._plotAreaMouseUp = function (a, d) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                var c =
                    ...
                    f = 0 <= this.zoomType.indexOf("y"), p = !1;
                this.resetOverlayedCanvas();
                if ("xySwapped" === this.plotInfo.axisPlacement) var l = f, f = e, e = l;
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    p && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter.type =
                        "rangeChanging", this.stockChart.dispatchEvent("rangeChanging", this.stockChart._rangeEventParameter, this.stockChart)), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter.type = "rangeChanged", this.stockChart.dispatchEvent("rangeChanged", this.stockChart._rangeEventParameter, this.stockChart)), p && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Ja(this._zoomButton,
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisY &&
                    0 < this.axisY.length) for (p = 0; p < this.axisY.length; p++) this.axisY[p].crosshair && this.axisY[p].crosshair.enabled && this.axisY[p].renderCrosshair(a, d);
        ...
        m.prototype._plotAreaMouseMove = function (a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                var c = 0, b = 0, e = c = null, e = 0 <= this.zoomType.indexOf("x"),
                    f = 0 <= this.zoomType.indexOf("y"), p = this;
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = {
                    ...
                    return function () {
                        p._zoomPanToSelectedRegion(b, c, e, f, !0) && (p._dispatchRangeEvent("rangeChanging", "pan"), p.stockChart && (p.stockChart.navigator && p.stockChart.navigator.enabled) && (p.stockChart._rangeEventParameter.type = "rangeChanging", p.stockChart.dispatchEvent("rangeChanging", p.stockChart._rangeEventParameter, p.stockChart)), p.render(),
                            p._dispatchRangeEvent("rangeChanged", "pan"), p.stockChart && (p.stockChart.navigator && p.stockChart.navigator.enabled) && (p.stockChart._rangeEventParameter.type = "rangeChanged", p.stockChart.dispatchEvent("rangeChanged", p.stockChart._rangeEventParameter, p.stockChart)), p.dragStartPoint.x = a, p.dragStartPoint.y = d)
                    }
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), p = 0 <= this.zoomType.indexOf("y"), l = !1, A = [], h = [], n = [], r = 0; r < this._axes.length; r++) ("axisX" === this._axes[r].type && f || "axisY" === this._axes[r].type && p) && h.push(this._axes[r]);
            for (p = 0; p < h.length; p++) {
                var r = h[p], f = !1, q = r.convertPixelToValue({x: a, y: d}), g = r.convertPixelToValue({
                    x: c,
                    y: b
                });
                if (q > g) var z = g, g = q, q = z;
                if (r.scaleBreaks) for (z = 0; !f && z < r.scaleBreaks._appliedBreaks.length; z++) f = r.scaleBreaks._appliedBreaks[z].startValue <= q && r.scaleBreaks._appliedBreaks[z].endValue >= g;
                if (isFinite(r.dataInfo.minDiff)) if (z = r.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && z < Math.pow(r.dataInfo.minDiff, 3) || !r.logarithmic && z < 3 * Math.abs(r.dataInfo.minDiff)) || q < r.minimum || g > r.maximum)) A.push(r), n.push({
                    val1: q,
                    val2: g
                }),
                    l = !0; else if (!e) {
        ...
        m.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea, b = 0, e = 0, f = 0, p = 0, l = b = p = e = f = 0, A = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                var h = this._indexLabels[a], n = h.chartType.toLowerCase(), r, q,
                    l = la("indexLabelFontColor", h.dataPoint,
                        h.dataSeries), A = la("indexLabelFontSize", h.dataPoint, h.dataSeries);
                ...
                var p = la("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                    ...
                    z = la("indexLabelLineDashType", h.dataPoint, h.dataSeries),
                    k = la("indexLabelLineColor", h.dataPoint, h.dataSeries), m =
                        t(h.dataPoint.indexLabelLineThickness) ? t(h.dataSeries.options.indexLabelLineThickness) ? 0 : h.dataSeries.options.indexLabelLineThickness : h.dataPoint.indexLabelLineThickness,
                ...
                if (null !== E && "" !== E) {
                    ...
                    if ("stackedarea100" === n) {
                        ...
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x >
                            B.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < y.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > y.viewportMaximum) continue
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) u = "auto", p = 4; else if (0 <= n.indexOf("stacked")) "auto" === u && (u = "inside"); else if ("bubble" === n || "scatter" === n) u = "inside";
                        r = h.point.x -
                            l / 2;
                    ...
                    } else 0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (u = "auto", e = 4) : 0 <= n.indexOf("stacked") ? "auto" === u && (u = "inside") : "bubble" === n && (u = "inside"), q = h.point.y - A / 2, "inside" !== u ? (p = c.x1, f = c.x2, 0 > C ? (r = h.point.x - l - e - b, r < p && (r = "auto" === u ? Math.max(h.point.x, p) + e + b : p + e + b, v = r + l > h.point.x)) : (r = h.point.x + e + b, r > f - l - e - b && (r = "auto" ===
                    u ? Math.min(h.point.x, f) - l - e - b : f - l - e - b, v = r < h.point.x))) : (p = Math.max(h.bounds.x1, c.x1), Math.min(h.bounds.x2, c.x2), b = 0 <= n.indexOf("range") || "error" === n ? 0 > C ? Math.max(h.bounds.x1, c.x1) + l / 2 + e : Math.min(h.bounds.x2, c.x2) - l / 2 - e : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2, r = 0 > C ? Math.max(h.point.x, b) - l / 2 : Math.min(h.point.x, b) - l / 2, r = Math.max(r, p));
                    "vertical" === x && (q += A);
                    g.x = r;
                    g.y = q;
                    g.render(!0);
                    m && ("inside" !== u && (0 > n.indexOf("bar") && ("error" !== n || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 ||
                        !v) && (0 > n.indexOf("column") && ("error" !== n || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2 || !v)) && (d.lineWidth = m, d.strokeStyle = k ? k : "gray", d.setLineDash && d.setLineDash(N(z, m)), d.beginPath(), d.moveTo(h.point.x, h.point.y), 0 <= n.indexOf("bar") || "error" === n && h.axisSwapped ? d.lineTo(r + (0 < h.direction ? 0 : l), q + ("horizontal" === x ? A : -A) / 2) : 0 <= n.indexOf("column") || "error" === n && !h.axisSwapped ? d.lineTo(r + l / 2, q + ((0 < h.direction ? A : -A) + ("horizontal" === x ? A : -A)) / 2) : d.lineTo(r + l / 2, q + ((q < h.point.y ? A : -A) + ("horizontal" === x ? A :
                        -A)) / 2), d.stroke())
                }
            }
            d = {
            ...
            for (a = 0; a < this._indexLabels.length; a++) h = this._indexLabels[a], g = la("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), h.dataSeries.indexLabelBackgroundColor = t(g) ? s ? "transparent" : null : g;
            return d
        };
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var A = a.dataSeriesIndexes[l], h = this.data[A];
                    c.lineWidth = h.lineThickness;
                    var n = h.dataPoints, r = "solid";
                    if (c.setLineDash) {
                        var q = N(h.nullDataLineDashType, h.lineThickness), r = h.lineDashType,
                            g = N(r, h.lineThickness);
                        c.setLineDash(g)
                    }
                    var z = h.id;
                    this._eventManager.objectMap[z] = {objectType: "dataSeries", dataSeriesIndex: A};
                    z = P(z);
                    b.strokeStyle = z;
                    b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0;
                    var z = h._colorSet, k = z = h.lineColor = h.options.lineColor ? h.options.lineColor : z[0];
                    c.strokeStyle = z;
                    var m = !0, u = 0, x, t;
                    c.beginPath();
                    if (0 < n.length) {
                        for (var C = !1, u = 0; u < n.length; u++) if (x = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C))) if ("number" !== typeof n[u].y) 0 < u && !(h.connectNullData || C || m) && (c.stroke(), s && b.stroke()), C = !0; else {
                            x = a.axisX.convertValueToPixel(x);
                            t =
                                a.axisY.convertValueToPixel(n[u].y);
                            ...
                            m || C ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), r = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, t), s && b.lineTo(x, t)) : (c.beginPath(), c.moveTo(x, t), s && (b.beginPath(), b.moveTo(x, t))), C = m = !1) : (c.lineTo(x,
                                t), s && b.lineTo(x, t), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, t), s && (b.stroke(), b.beginPath(), b.moveTo(x, t))));
                            p = {x: x, y: t};
                            u < n.length - 1 && (k !== (n[u].lineColor || z) || r !== (n[u].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, t), k = n[u].lineColor || z, c.strokeStyle = k, c.setLineDash && (n[u].lineDashType ? (r = n[u].lineDashType, c.setLineDash(N(r, h.lineThickness))) : (r = h.lineDashType, c.setLineDash(g))));
                            if (0 < n[u].markerSize || 0 < h.markerSize) {
                                var y = h.getMarkerProperties(u, x, t, c);
                                f.push(y);
                                B = P(B);
                                s && f.push({
                                    x: x,
                            ...
                            (n[u].indexLabel || h.indexLabel || n[u].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "line",
                                dataPoint: n[u],
                                dataSeries: h,
                                point: {x: x, y: t},
        ...
        m.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    c.beginPath();
                    if (0 < n.length) {
                        for (var C = !1, u = 0; u < n.length; u++) if (x = n[u].getTime ? n[u].x.getTime() : n[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C))) if ("number" !== typeof n[u].y) 0 < u && !(h.connectNullData || C || m) && (c.stroke(),
                        s && b.stroke()), C = !0; else {
                            var B = t;
                            x = a.axisX.convertValueToPixel(x);
                            ...
                            m || C ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), r = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, B), c.lineTo(x, t), s && (b.lineTo(x,
                                B), b.lineTo(x, t))) : (c.beginPath(), c.moveTo(x, t), s && (b.beginPath(), b.moveTo(x, t))), C = m = !1) : (c.lineTo(x, B), s && b.lineTo(x, B), c.lineTo(x, t), s && b.lineTo(x, t), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, t), s && (b.stroke(), b.beginPath(), b.moveTo(x, t))));
                            p = {x: x, y: t};
                            u < n.length - 1 && (k !== (n[u].lineColor || z) || r !== (n[u].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, t), k = n[u].lineColor || z, c.strokeStyle = k, c.setLineDash && (n[u].lineDashType ? (r = n[u].lineDashType, c.setLineDash(N(r, h.lineThickness))) :
                                (r = h.lineDashType, c.setLineDash(g))));
                            if (0 < n[u].markerSize || 0 < h.markerSize) B = h.getMarkerProperties(u, x, t, c), f.push(B), y = P(y), s && f.push({
                                x: x,
                                y: t,
                                ctx: b,
                                type: B.type,
        ...
        m.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var z = h._colorSet,
                        k = z = h.lineColor = h.options.lineColor ? h.options.lineColor : z[0];
                    b.strokeStyle = z;
                    var m = 0, u, x, t = [];
                    b.beginPath();
                    if (0 < n.length) for (x = !1, m = 0; m < n.length; m++) if (u = n[m].getTime ? n[m].x.getTime() : n[m].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x))) if ("number" !== typeof n[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < t.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = q, r = h.nullDataLineDashType) : (d(t), t = [])), x = !0;
                    else {
                        ...
                        t[t.length] = {x: u, y: x};
                        m < n.length - 1 && (k !== (n[m].lineColor || z) || r !== (n[m].lineDashType || h.lineDashType)) && (k = n[m].lineColor || z, t[t.length - 1].newStrokeStyle = k, b.setLineDash && (n[m].lineDashType ? (r = n[m].lineDashType, t[t.length - 1].newLineDashArray = N(r, h.lineThickness)) : (r = h.lineDashType, t[t.length - 1].newLineDashArray =
                            g)));
                        if (0 < n[m].markerSize || 0 < h.markerSize) {
                            var B = h.getMarkerProperties(m, u, x, b);
                            p.push(B);
                            C = P(C);
                            s && p.push({
                                x: u,
        ...
        m.prototype.renderColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, l, A,
                    ...
                    n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width,
                        0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, r = a.axisX.dataInfo.minDiff;
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < z.length) for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < z.length; f++) if (z[f].getTime ? A = z[f].x.getTime() :
                        A = z[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof z[f].y) {
                        p = a.axisX.convertValueToPixel(A);
                        l = a.axisY.convertValueToPixel(z[f].y);
                        ...
                        var m = a.axisX.reversed ? p - r << 0 : p + r << 0, u;
                        0 <= z[f].y ? u = h : (u = l, l = h);
                        l > u && (b = l, l = u, u = b);
                        b = z[f].color ? z[f].color : g._colorSet[f % g._colorSet.length];
                        ca(c, p, l, m, u, b, 0, null, k && 0 <= z[f].y,
                            0 > z[f].y && k, !1, !1, g.fillOpacity);
                        b = g.dataPointIds[f];
                        this._eventManager.objectMap[b] = {
                            id: b,
                            objectType: "dataPoint",
                        ...
                        b = P(b);
                        s && ca(this._eventManager.ghostCtx, p, l, m, u, b, 0, null, !1, !1, !1, !1);
                        (z[f].indexLabel || g.indexLabel || z[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "column",
                            dataPoint: z[f],
                            dataSeries: g,
                            point: {x: p + (m - p) / 2, y: 0 > z[f].y === a.axisY.reversed ? l : u},
                            direction: 0 > z[f].y === a.axisY.reversed ? 1 : -1,
                            bounds: {
                                x1: p,
                                y1: Math.min(l, u), x2: m, y2: Math.max(l, u)
                            },
                            color: b
                        })
                    }
        ...
        m.prototype.renderStackedColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], p = [], l = [], A = [], h = 0, n, r,
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var k = a.dataSeriesIndexes[z],
                        m = this.data[k], u = m.dataPoints;
                    if (0 < u.length) {
                        ...
                        for (h = 0; h < u.length; h++) if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                            ...
                            var t = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = t + g << 0, B;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) l[b] = u[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (r = a.axisY.convertValueToPixel(l[b]),
                                B = "undefined" !== typeof f[b] ? f[b] : q, f[b] = r); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = u[h].y + (A[b] ? A[b] : 0), B = a.axisY.convertValueToPixel(A[b]), r = "undefined" !== typeof p[b] ? p[b] : q, p[b] = B; else if (r = a.axisY.convertValueToPixel(u[h].y), 0 <= u[h].y) {
                                var y = "undefined" !== typeof f[b] ? f[b] : 0;
                                r -= y;
                                B = q - y;
                                f[b] = y + (B - r)
                            } else y = p[b] ? p[b] : 0, B = r + y, r = q + y, p[b] = y + (B - r);
                            b = u[h].color ? u[h].color : m._colorSet[h % m._colorSet.length];
                            ca(c, t, r, C, B, b, 0, null, x && 0 <= u[h].y, 0 > u[h].y && x, !1,
                                !1, m.fillOpacity);
                            b = m.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                            ...
                            b = P(b);
                            s && ca(this._eventManager.ghostCtx, t, r, C, B, b, 0, null, !1, !1, !1, !1);
                            (u[h].indexLabel || m.indexLabel || u[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "stackedColumn",
                                dataPoint: u[h],
                                dataSeries: m,
                                point: {x: n, y: 0 <= u[h].y ? r : B},
                                direction: 0 > u[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {
                                    x1: t, y1: Math.min(r, B), x2: C, y2: Math.max(r,
                                        B)
                                },
                                color: b
                            })
        ...
        m.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var k = a.dataSeriesIndexes[z],
                        m = this.data[k], u = m.dataPoints;
                    if (0 < u.length) for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < u.length; h++) if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                        n = a.axisX.convertValueToPixel(b);
                        r = 0 !== a.dataPointYSums[b] ? 100 * (u[h].y / a.dataPointYSums[b]) : 0;
                        var t = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = t + g << 0, B;
                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) {
                            ...
                            B = f[b] ? f[b] : q;
                            f[b] = r
                        } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = r + ("undefined" !== typeof A[b] ? A[b] : 0), B = a.axisY.convertValueToPixel(A[b]), r = p[b] ? p[b] : q, p[b] = B; else if (r = a.axisY.convertValueToPixel(r), 0 <= u[h].y) {
                            var y = "undefined" !== typeof f[b] ? f[b] : 0;
                            r -= y;
                            B = q - y;
                            a.dataSeriesIndexes.length - 1 === z && 1 >= Math.abs(e.y1 - r) && (r = e.y1);
                            f[b] = y + (B - r)
                        } else y = "undefined" !== typeof p[b] ?
                            p[b] : 0, B = r + y, r = q + y, a.dataSeriesIndexes.length - 1 === z && 1 >= Math.abs(e.y2 - B) && (B = e.y2), p[b] = y + (B - r);
                        b = u[h].color ? u[h].color : m._colorSet[h % m._colorSet.length];
                        ca(c, t, r, C, B, b, 0, null, x && 0 <= u[h].y, 0 > u[h].y && x, !1, !1, m.fillOpacity);
                        b = m.dataPointIds[h];
                        this._eventManager.objectMap[b] = {
                            id: b,
                            objectType: "dataPoint",
                        ...
                        b = P(b);
                        s && ca(this._eventManager.ghostCtx, t, r, C, B, b, 0, null, !1, !1, !1, !1);
                        (u[h].indexLabel || m.indexLabel || u[h].indexLabelFormatter || m.indexLabelFormatter) &&
                        this._indexLabels.push({
                            ...
                            point: {x: n, y: 0 <= u[h].y ? r : B},
                            direction: 0 > u[h].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: t, y1: Math.min(r, B), x2: C, y2: Math.max(r, B)},
                            color: b
                        })
                    }
                }
        ...
        m.prototype.renderBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b =
                        null, e = this.plotArea, f = 0, p, l, A,
                    h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < z.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < z.length; f++) if (z[f].getTime ? A = z[f].x.getTime() : A = z[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof z[f].y) {
                            l = a.axisX.convertValueToPixel(A);
                            p = a.axisY.convertValueToPixel(z[f].y);
                            ...
                            var m = a.axisX.reversed ? l - r << 0 : l + r << 0, u;
                            0 <= z[f].y ? u = h : (u = p, p = h);
                            b = z[f].color ? z[f].color : g._colorSet[f % g._colorSet.length];
                            ca(c, u, l, p, m, b, 0, null, k, !1, !1, !1, g.fillOpacity);
                            b = g.dataPointIds[f];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b =
                                P(b);
                            s && ca(this._eventManager.ghostCtx, u, l, p, m, b, 0, null, !1, !1, !1, !1);
                            (z[f].indexLabel || g.indexLabel || z[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "bar",
                                dataPoint: z[f],
                                dataSeries: g,
                                point: {x: 0 <= z[f].y ? p : u, y: l + (m - l) / 2},
                                direction: 0 > z[f].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(u, p), y1: l, x2: Math.max(u, p), y2: m},
                                color: b
                            })
                        }
                    }
        ...
        m.prototype.renderStackedBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var k = a.dataSeriesIndexes[z], m = this.data[k], u = m.dataPoints;
                    if (0 < u.length) {
                        var x = 5 < g && m.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (h = 0; h < u.length; h++) if (b = u[h].x.getTime ? u[h].x.getTime() :
                            u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                            r = a.axisX.convertValueToPixel(b);
                            var t = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = t + g << 0, B;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) l[b] = u[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (B = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(l[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = u[h].y + (A[b] ? A[b] : 0), n = p[b] ?
                                p[b] : q, p[b] = B = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(u[h].y), 0 <= u[h].y) {
                                var y = f[b] ? f[b] : 0;
                                B = q + y;
                                n += y;
                                f[b] = y + (n - B)
                            } else y = p[b] ? p[b] : 0, B = n - y, n = q - y, p[b] = y + (n - B);
                            b = u[h].color ? u[h].color : m._colorSet[h % m._colorSet.length];
                            ca(c, B, t, n, C, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                            b = m.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = P(b);
                            s && ca(this._eventManager.ghostCtx, B, t, n, C, b, 0, null, !1, !1, !1,
                                !1);
                            (u[h].indexLabel || m.indexLabel || u[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "stackedBar",
                                dataPoint: u[h],
                                dataSeries: m,
                                point: {x: 0 <= u[h].y ? n : B, y: r},
                                direction: 0 > u[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(B, n), y1: t, x2: Math.max(B, n), y2: C},
                                color: b
                            })
                        }
                    }
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < u.length) {
                        ...
                        "number" === typeof u[h].y) {
                            r = a.axisX.convertValueToPixel(b);
                            var t;
                            t = 0 !== a.dataPointYSums[b] ? 100 * (u[h].y / a.dataPointYSums[b]) : 0;
                            var C = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = C + g << 0;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) {
                                l[b] = t + (l[b] ? l[b] : 0);
                                if (0 >= l[b]) continue;
                                t = f[b] ? f[b] : q;
                                f[b] = n = a.axisY.convertValueToPixel(l[b])
                            } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = t + (A[b] ? A[b] : 0), n = p[b] ? p[b] :
                                q, p[b] = t = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(t), 0 <= u[h].y) {
                                var y = f[b] ? f[b] : 0;
                                t = q + y;
                                n += y;
                                a.dataSeriesIndexes.length - 1 === z && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                                f[b] = y + (n - t)
                            } else y = p[b] ? p[b] : 0, t = n - y, n = q - y, a.dataSeriesIndexes.length - 1 === z && 1 >= Math.abs(e.x1 - t) && (t = e.x1), p[b] = y + (n - t);
                            b = u[h].color ? u[h].color : m._colorSet[h % m._colorSet.length];
                            ca(c, t, C, n, B, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                            b = m.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b, objectType: "dataPoint", dataSeriesIndex: k,
                                dataPointIndex: h, x1: t, y1: C, x2: n, y2: B
                            };
                            b = P(b);
                            s && ca(this._eventManager.ghostCtx, t, C, n, B, b, 0, null, !1, !1, !1, !1);
                            (u[h].indexLabel || m.indexLabel || u[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "stackedBar100",
                                dataPoint: u[h],
                                dataSeries: m,
                                point: {x: 0 <= u[h].y ? n : t, y: r},
                                direction: 0 > u[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(t, n), y1: C, x2: Math.max(t, n), y2: B},
                                color: b
                            })
                        }
                    }
        ...
        m.prototype.renderArea = function (a) {
            ...
            function b() {
                B && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = E : 0 > a.axisY.viewportMaximum ? C = l.y1 : 0 < a.axisY.viewportMinimum && (C = E), f.lineTo(m, C), f.lineTo(B.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, s && (p.lineTo(m, C), p.lineTo(B.x, C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(m, u), p.beginPath(), p.moveTo(m, u), B = {
                    x: m,
                    y: u
                })
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                f.clip();
                s && (p.beginPath(), p.rect(h.x1, h.y1, h.width, h.height), p.clip());
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var q = a.dataSeriesIndexes[r], g = this.data[q], z = g.dataPoints, A = g.id;
                    ...
                    d = !0;
                    var k = 0, m, u, t,
                        E = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), C, B = null;
                    if (0 < z.length) {
                        ...
                        for (var ja = !0; k < z.length; k++) if (t = z[k].x.getTime ? z[k].x.getTime() : z[k].x, !(t < a.axisX.dataInfo.viewPortMin ||
                            t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja))) if ("number" !== typeof z[k].y) g.connectNullData || (ja || d) || b(), ja = !0; else {
                            m = a.axisX.convertValueToPixel(t);
                            u = a.axisY.convertValueToPixel(z[k].y);
                            d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, B = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, u), s && p.lineTo(m, u)) : (f.beginPath(), f.moveTo(m, u), s &&
                            (p.beginPath(), p.moveTo(m, u)), B = {
                                x: m,
                                y: u
                            }), ja = d = !1) : (f.lineTo(m, u), s && p.lineTo(m, u), 0 == k % 250 && b());
                            n = {x: m, y: u};
                            k < z.length - 1 && (w !== (z[k].lineColor || v) || c !== (z[k].lineDashType || g.lineDashType)) && (b(), w = z[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (z[k].lineDashType ? (c = z[k].lineDashType, f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(R))));
                            ...
                            0 !== z[k].markerSize &&
                            (0 < z[k].markerSize || 0 < g.markerSize) && (t = g.getMarkerProperties(k, m, u, f), A.push(t), Z = P(Z), s && A.push({
                                x: m,
                                y: u,
                                ctx: p,
                                type: t.type,
                            ...
                            (z[k].indexLabel || g.indexLabel || z[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "area",
                                dataPoint: z[k],
                                dataSeries: g,
                                point: {x: m, y: u},
                                direction: 0 > z[k].y === a.axisY.reversed ? 1 : -1,
                                color: y
                            })
                        }
                        b();
        ...
        m.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    b.fill();
                    b.globalAlpha = 1;
                    s && (e.lineTo(c[c.length - 1].x, m), e.lineTo(u.x, m), e.closePath(), e.fill())
                }
            }

            var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, p = [], l = this.plotArea;
                b.save();
                s && e.save();
                b.beginPath();
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var h = a.dataSeriesIndexes[A], n = this.data[h], r = n.dataPoints, p = n.id;
                    this._eventManager.objectMap[p] = {objectType: "dataSeries", dataSeriesIndex: h};
                    p = P(p);
                    e.fillStyle = p;
                    var p = [], q = 0, g, z,
                        k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, u = null,
                        t = [];
                    if (0 < r.length) {
                        var E = n._colorSet[q % n._colorSet.length], C = n.lineColor = n.options.lineColor || E, B = C;
                        b.fillStyle = E;
                        b.strokeStyle =
                            C;
                        ...
                        var y = "solid";
                        if (b.setLineDash) {
                            var w = N(n.nullDataLineDashType, n.lineThickness), y = n.lineDashType,
                                D = N(y, n.lineThickness);
                            b.setLineDash(D)
                        }
                        for (z = !1; q < r.length; q++) if (g = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !z))) if ("number" !== typeof r[q].y) 0 < q && !z && (n.connectNullData ? b.setLineDash && (0 < t.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = w,
                            y = n.nullDataLineDashType) : (d(), t = [])), z = !0; else {
                            g = a.axisX.convertValueToPixel(g);
                            z = a.axisY.convertValueToPixel(r[q].y);
                            ...
                            t[t.length] = {x: g, y: z};
                            q < r.length - 1 && (B !== (r[q].lineColor || C) || y !== (r[q].lineDashType || n.lineDashType)) && (B = r[q].lineColor || C, t[t.length - 1].newStrokeStyle = B, b.setLineDash && (r[q].lineDashType ? (y = r[q].lineDashType, t[t.length - 1].newLineDashArray = N(y, n.lineThickness)) :
                                (y = n.lineDashType, t[t.length - 1].newLineDashArray = D)));
                            if (0 !== r[q].markerSize && (0 < r[q].markerSize || 0 < n.markerSize)) {
                                var R = n.getMarkerProperties(q, g, z, b);
                                p.push(R);
                                S = P(S);
                                s && p.push({
                                    x: g,
        ...
        m.prototype.renderStepArea = function (a) {
            ...
            function b() {
                B && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = E : 0 > a.axisY.viewportMaximum ? C = l.y1 : 0 < a.axisY.viewportMinimum && (C = E), f.lineTo(m, C), f.lineTo(B.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, s && (p.lineTo(m, C), p.lineTo(B.x, C), p.closePath(), p.fill()),
                    f.beginPath(), f.moveTo(m, u), p.beginPath(), p.moveTo(m, u), B = {x: m, y: u})
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                s && (p.beginPath(), p.rect(h.x1, h.y1, h.width, h.height), p.clip());
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var q = a.dataSeriesIndexes[r], g = this.data[q], z = g.dataPoints,
                        A = g.id;
                    this._eventManager.objectMap[A] = {objectType: "dataSeries", dataSeriesIndex: q};
                    A = P(A);
                    p.fillStyle = A;
                    ...
                    if (0 < z.length) {
                        ...
                        var S = "solid";
                        if (f.setLineDash) {
                            var R = N(g.nullDataLineDashType, g.lineThickness), S = g.lineDashType,
                                D = N(S, g.lineThickness);
                            f.setLineDash(D)
                        }
                        for (; k <
                               z.length; k++) if (t = z[k].x.getTime ? z[k].x.getTime() : z[k].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                            var Z = u;
                            "number" !== typeof z[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(t), u = a.axisY.convertValueToPixel(z[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, B = n, S = g.nullDataLineDashType,
                                f.setLineDash(R)), f.lineTo(m, Z), f.lineTo(m, u), s && (p.lineTo(m, Z), p.lineTo(m, u))) : (f.beginPath(), f.moveTo(m, u), s && (p.beginPath(), p.moveTo(m, u)), B = {
                                x: m,
                                y: u
                            }), c = d = !1) : (f.lineTo(m, Z), s && p.lineTo(m, Z), f.lineTo(m, u), s && p.lineTo(m, u), 0 == k % 250 && b()), n = {
                                x: m,
                                y: u
                            }, k < z.length - 1 && (w !== (z[k].lineColor || v) || S !== (z[k].lineDashType || g.lineDashType)) && (b(), w = z[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (z[k].lineDashType ? (S = z[k].lineDashType, f.setLineDash(N(S, g.lineThickness))) : (S = g.lineDashType, f.setLineDash(D)))),
                                t = g.dataPointIds[k], this._eventManager.objectMap[t] = {
                                id: t,
                                objectType: "dataPoint",
                                dataSeriesIndex: q,
                                dataPointIndex: k,
                                x1: m,
                                y1: u
                            }, 0 !== z[k].markerSize && (0 < z[k].markerSize || 0 < g.markerSize) && (Z = g.getMarkerProperties(k, m, u, f), A.push(Z), t = P(t), s && A.push({
                                x: m,
                                y: u,
                                ctx: p,
                                type: Z.type,
                                ...
                                chartType: "stepArea", dataPoint: z[k], dataSeries: g, point: {
                                    x: m,
                                    y: u
                                }, direction: 0 > z[k].y === a.axisY.reversed ? 1 : -1, color: y
                            }))
                        }
                        b();
                        X.drawMarkers(A)
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx :
                c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = [], l = this.plotArea, A = [], h = [], n = [], r = [], q = 0, g, k,
                    m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    t = this._eventManager.ghostCtx, u, x, E;
                s && t.beginPath();
                b.save();
                s && t.save();
                b.beginPath();
                b.rect(l.x1, l.y1, l.width, l.height);
                b.clip();
                s && (t.beginPath(), t.rect(l.x1, l.y1, l.width, l.height), t.clip());
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var B = a.dataSeriesIndexes[C], y = this.data[B], v = y.dataPoints;
                    y.dataPointIndexes =
                        [];
                    for (q = 0; q < v.length; q++) B = v[q].x.getTime ? v[q].x.getTime() : v[q].x, y.dataPointIndexes[B] = q, e[B] || (n.push(B), e[B] = !0);
                    n.sort(Oa)
                }
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    B = a.dataSeriesIndexes[C];
                    y = this.data[B];
                    v = y.dataPoints;
                    x = !0;
                    h = [];
                    ...
                    t.fillStyle = q;
                    if (0 < n.length) {
                        var e = y._colorSet[0], w = y.lineColor = y.options.lineColor || e, S = w;
                        b.fillStyle = e;
                        b.strokeStyle = w;
                        ...
                        if (b.setLineDash) {
                            var R =
                                N(y.nullDataLineDashType, y.lineThickness);
                            E = y.lineDashType;
                            var D = N(E, y.lineThickness);
                            b.setLineDash(D)
                        }
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q], fa = null,
                                fa = 0 <= y.dataPointIndexes[f] ? v[y.dataPointIndexes[f]] : {x: f, y: null};
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !Z))) if ("number" !== typeof fa.y) y.connectNullData || (Z || x) || d(), Z = !0; else {
                                ...
                                h.push({x: g, y: m - ma});
                                A[f] = m - k;
                                x || Z ? (!x && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || E === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (x = h.pop(), E = h[h.length - 1], d(), b.moveTo(u.x, u.y), h.push(E), h.push(x), E = y.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, k), s && t.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), s && (t.beginPath(),
                                    t.moveTo(g, k))), Z = x = !1) : (b.lineTo(g, k), s && t.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), s && t.moveTo(g, k), h.push({
                                    x: g,
                                    y: m - ma
                                })));
                                u = {x: g, y: k};
                                q < v.length - 1 && (S !== (v[q].lineColor || w) || E !== (v[q].lineDashType || y.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({
                                    x: g,
                                    y: m - ma
                                }), S = v[q].lineColor || w, b.strokeStyle = S, b.setLineDash && (v[q].lineDashType ? (E = v[q].lineDashType, b.setLineDash(N(E, y.lineThickness))) : (E = y.lineDashType, b.setLineDash(D))));
                                ...
                                0 <= y.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < y.markerSize) && (ma = y.getMarkerProperties(y.dataPointIndexes[f], g, k, b), p.push(ma), f = P(F), s && p.push({
                                    x: g,
                                    y: k,
                                    ctx: t,
                                    type: ma.type,
                                ...
                                (fa.indexLabel || y.indexLabel || fa.indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                ...
                X.drawMarkers(p);
                s && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                    0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), t.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderStackedArea100 = function (a) {
            function d() {
                ...
                b.globalAlpha = 1;
                b.beginPath();
                s && (E.closePath(), E.fill(), E.beginPath());
                h = []
            }

            var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, l = [], k = [], h = [], n = [], r = [], q = 0, g, z, m, t, u,
                ...
                b.clip();
                s && (E.beginPath(), E.rect(p.x1, p.y1, p.width, p.height), E.clip());
                for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var B = a.dataSeriesIndexes[v],
                        y = this.data[B], w = y.dataPoints;
                    y.dataPointIndexes = [];
                    for (q = 0; q < w.length; q++) B = w[q].x.getTime ? w[q].x.getTime() : w[q].x, y.dataPointIndexes[B] = q, e[B] || (n.push(B), e[B] = !0);
                    n.sort(Oa)
                }
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    h = [];
                    if (0 < n.length) {
                        var e = y._colorSet[q % y._colorSet.length], D = y.lineColor = y.options.lineColor || e, S = D;
                        b.fillStyle = e;
                        b.strokeStyle =
                            D;
                        b.lineWidth = y.lineThickness;
                        u = "solid";
                        if (b.setLineDash) {
                            var R = N(y.nullDataLineDashType, y.lineThickness);
                            u = y.lineDashType;
                            var F = N(u, y.lineThickness);
                            b.setLineDash(F)
                        }
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q], fa = null,
                                fa = 0 <= y.dataPointIndexes[f] ? w[y.dataPointIndexes[f]] : {x: f, y: null};
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !Z))) if ("number" !== typeof fa.y) y.connectNullData || (Z || t) || d(), Z = !0; else {
                                var ma;
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                    r[f] = ma + (r[f] ? r[f] : 0);
                                    if (0 >= r[f] && a.axisY.logarithmic) continue;
                                    z = a.axisY.convertValueToPixel(r[f])
                                } else z = a.axisY.convertValueToPixel(ma), z -= ba;
                                h.push({x: g, y: x - ba});
                                k[f] = x - z;
                                t || Z ? (!t && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || u === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (t = h.pop(), u = h[h.length - 1], d(), b.moveTo(m.x,
                                    m.y), h.push(u), h.push(t), u = y.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, z), s && E.lineTo(g, z)) : (b.beginPath(), b.moveTo(g, z), s && (E.beginPath(), E.moveTo(g, z))), Z = t = !1) : (b.lineTo(g, z), s && E.lineTo(g, z), 0 == q % 250 && (d(), b.moveTo(g, z), s && E.moveTo(g, z), h.push({
                                    x: g,
                                    y: x - ba
                                })));
                                m = {x: g, y: z};
                                q < w.length - 1 && (S !== (w[q].lineColor || D) || u !== (w[q].lineDashType || y.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, z), h.push({
                                    x: g,
                                    y: x - ba
                                }), S = w[q].lineColor || D, b.strokeStyle = S, b.setLineDash && (w[q].lineDashType ? (u = w[q].lineDashType,
                                    b.setLineDash(N(u, y.lineThickness))) : (u = y.lineDashType, b.setLineDash(F))));
                                if (0 <= y.dataPointIndexes[f]) {
                                    var G = y.dataPointIds[y.dataPointIndexes[f]];
                                ...
                                0 <= y.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < y.markerSize) && (ba = y.getMarkerProperties(q, g, z, b), l.push(ba), f = P(G), s && l.push({
                                    x: g,
                                    y: z,
                                    ctx: E,
                                    type: ba.type,
                ...
                b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height), E.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) for (var n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ||
                ...
                for (var z = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, z), h = 0; h < a.dataSeriesIndexes.length; h++) if (n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++) if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                    ...
                    var g = q[e].z,
                        t = 2 * Math.max(Math.sqrt((l === k ? m / 2 : z + (m - z) / (l - k) * (g - k)) / Math.PI) << 0, 1),
                    ...
                    t = P(u);
                    s && X.drawMarker(f, p, this._eventManager.ghostCtx, g.type, g.size, t, t, g.borderThickness);
                    (q[e].indexLabel || r.indexLabel ||
                        ...
                        point: {x: f, y: p},
                        direction: 1,
                        bounds: {x1: f - g.size / 2, y1: p - g.size / 2, x2: f + g.size / 2, y2: p + g.size / 2},
                        color: null
                    })
                }
                s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
        ...
        m.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var k = a.dataSeriesIndexes[l], h = this.data[k], n = h.dataPoints;
                    if (0 < n.length) {
                        c.strokeStyle = "#4572A7 ";
                        Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2);
                        for (var r = 0, q = 0, e = 0; e < n.length; e++) if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                            ...
                            }, r = P(r), s && X.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, r, r, g.borderThickness), (n[e].indexLabel || h.indexLabel || n[e].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: n[e],
                                dataSeries: h,
                                point: {x: f, y: p},
        ...
        m.prototype.renderCandlestick =
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null, f = null, p = this.plotArea, l = 0, k, h, n, r, q, g,
                        ...
                        z = a.axisX.dataInfo.minDiff;
                    isFinite(z) || (z = 0.3 * Math.abs(a.axisX.range));
                    z = this.options.dataPointWidth ?
                        this.dataPointWidth : 0.7 * p.width * (a.axisX.logarithmic ? Math.log(z) / Math.log(a.axisX.range) : Math.abs(z) / Math.abs(a.axisX.range)) << 0;
                    ...
                    c.clip();
                    s && (b.beginPath(), b.rect(p.x1, p.y1, p.width,
                        p.height), b.clip());
                    for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                        var v = a.dataSeriesIndexes[m], u = this.data[v], x = u.dataPoints;
                        if (0 < x.length) for (var E = 5 < z && u.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++) if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !t(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3]) {
                            ...
                            var C = k - z / 2 << 0, B = C + z << 0,
                                f = u.options.fallingColor ? u.fallingColor : u._colorSet[0],
                                e = x[l].color ? x[l].color : u._colorSet[0], y = Math.round(Math.max(1, 0.15 * z)),
                                w = 0 === y % 2 ? 0 : 0.5, D = u.dataPointIds[l];
                            ...
                            "candlestick" === u.type ? (c.moveTo(k - w, n), c.lineTo(k - w, Math.min(h, q)), c.stroke(), c.moveTo(k - w, Math.max(h, q)), c.lineTo(k - w, r), c.stroke(), ca(c, C, Math.min(h, q), B, Math.max(h, q), x[l].y[0] <= x[l].y[3] ? u.risingColor : f, y, e, E, E, !1, !1, u.fillOpacity), s && (e = P(D), b.strokeStyle = e, b.moveTo(k - w, n), b.lineTo(k - w, Math.min(h, q)), b.stroke(), b.moveTo(k - w, Math.max(h, q)), b.lineTo(k - w, r), b.stroke(), ca(b, C, Math.min(h, q), B, Math.max(h, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(k -
                                w, n), c.lineTo(k - w, r), c.stroke(), c.beginPath(), c.moveTo(k, h), c.lineTo(C, h), c.stroke(), c.beginPath(), c.moveTo(k, q), c.lineTo(B, q), c.stroke(), s && (e = P(D), b.strokeStyle = e, b.moveTo(k - w, n), b.lineTo(k - w, r), b.stroke(), b.beginPath(), b.moveTo(k, h), b.lineTo(C, h), b.stroke(), b.beginPath(), b.moveTo(k, q), b.lineTo(B, q), b.stroke()));
                            (x[l].indexLabel || u.indexLabel || x[l].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                                chartType: u.type,
                                dataPoint: x[l],
                                dataSeries: u,
                                point: {
                                    x: C + (B - C) / 2, y: a.axisY.reversed ?
                                        r : n
                                },
                                direction: 1,
                                bounds: {x1: C, y1: Math.min(n, r), x2: B, y2: Math.max(n, r)},
                                color: e
                            })
                        }
                    }
        ...
        m.prototype.renderBoxAndWhisker = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d,
                b = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, p = 0, l, k, h, n, r, q, g,
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    p = this.options.dataPointMaxWidth ?
                        this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width,
                    z = a.axisX.dataInfo.minDiff;
                isFinite(z) || (z = 0.3 * Math.abs(a.axisX.range));
                z = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(z) / Math.log(a.axisX.range) : Math.abs(z) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m = !1, m = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var u = a.dataSeriesIndexes[v], x = this.data[u], E = x.dataPoints;
                    if (0 < E.length) for (var C = 5 < z && x.bevelEnabled ? !0 : !1, p = 0; p < E.length; p++) if (E[p].getTime ? g = E[p].x.getTime() : g = E[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                    !t(E[p].y) && E[p].y.length && "number" === typeof E[p].y[0] && "number" === typeof E[p].y[1] && "number" === typeof E[p].y[2] && "number" === typeof E[p].y[3] && "number" === typeof E[p].y[4] && 5 === E[p].y.length) {
                        l = a.axisX.convertValueToPixel(g);
                        k = a.axisY.convertValueToPixel(E[p].y[0]);
                        h = a.axisY.convertValueToPixel(E[p].y[1]);
                        n = a.axisY.convertValueToPixel(E[p].y[2]);
                        r = a.axisY.convertValueToPixel(E[p].y[3]);
                        q = a.axisY.convertValueToPixel(E[p].y[4]);
                        var B = l - z / 2 << 0, y = l + z / 2 << 0, e = E[p].color ? E[p].color : x._colorSet[0],
                            w = Math.round(Math.max(1,
                                0.15 * z)), D = 0 === w % 2 ? 0 : 0.5,
                            S = E[p].whiskerColor ? E[p].whiskerColor : E[p].color ? x.whiskerColor ? x.whiskerColor : E[p].color : x.whiskerColor ? x.whiskerColor : e,
                            R = "number" === typeof E[p].whiskerThickness ? E[p].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : w,
                            F = E[p].whiskerDashType ? E[p].whiskerDashType : x.whiskerDashType,
                            Z = t(E[p].whiskerLength) ? t(x.options.whiskerLength) ? z : x.whiskerLength : E[p].whiskerLength,
                            Z = "number" === typeof Z ? 0 >= Z ? 0 : Z >= z ? z : Z : "string" === typeof Z ? parseInt(Z) * z / 100 >
                            z ? z : parseInt(Z) * z / 100 : z, fa = 1 === Math.round(R) % 2 ? 0.5 : 0,
                            ma = E[p].stemColor ? E[p].stemColor : E[p].color ? x.stemColor ? x.stemColor : E[p].color : x.stemColor ? x.stemColor : e,
                            ba = "number" === typeof E[p].stemThickness ? E[p].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : w,
                            G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                            J = E[p].stemDashType ? E[p].stemDashType : x.stemDashType,
                            I = E[p].lineColor ? E[p].lineColor : E[p].color ? x.lineColor ? x.lineColor : E[p].color : x.lineColor ? x.lineColor : e,
                            M = "number" === typeof E[p].lineThickness ?
                                E[p].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : w,
                            Q = E[p].lineDashType ? E[p].lineDashType : x.lineDashType,
                            K = 1 === Math.round(M) % 2 ? 0.5 : 0, V = x.upperBoxColor, wa = x.lowerBoxColor,
                            ra = t(x.options.fillOpacity) ? 1 : x.fillOpacity, O = x.dataPointIds[p];
                        ...
                        c.beginPath();
                        ca(c, B, Math.min(q, h), y, Math.max(h, q), wa, 0, e, m ? C : !1, m ? !1 : C, !1, !1, ra);
                        c.beginPath();
                        ca(c, B, Math.min(n, q), y, Math.max(q, n), V, 0, e, m ? !1 : C, m ? C : !1, !1, !1, ra);
                        c.beginPath();
                        c.lineWidth = w;
                        c.strokeStyle = e;
                        c.rect(B - D, Math.min(h, n) - D, y - B + 2 * D, Math.max(h,
                            n) - Math.min(h, n) + 2 * D);
                        c.stroke();
                        c.save();
                        0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(N(Q, M)), c.strokeStyle = I, c.lineWidth = M, c.moveTo(B, q - K), c.lineTo(y, q - K), c.stroke());
                        c.restore();
                        c.save();
                        0 < R && (c.beginPath(), c.setLineDash && c.setLineDash(N(F, R)), c.strokeStyle = S, c.lineWidth = R, c.moveTo(l - Z / 2 << 0, r - fa), c.lineTo(l + Z / 2 << 0, r - fa), c.stroke(), c.moveTo(l - Z / 2 << 0, k + fa), c.lineTo(l + Z / 2 << 0, k + fa), c.stroke());
                        c.restore();
                        s && (e = P(O), b.strokeStyle = e, b.lineWidth = ba, 0 < ba && (b.moveTo(l - D - G, h), b.lineTo(l -
                            D - G, Math.max(k, r)), b.stroke(), b.moveTo(l - D - G, Math.min(k, r)), b.lineTo(l - D - G, n), b.stroke()), ca(b, B, Math.max(h, n), y, Math.min(h, n), e, 0, null, !1, !1, !1, !1), 0 < R && (b.beginPath(), b.lineWidth = R, b.moveTo(l + Z / 2, r - fa), b.lineTo(l - Z / 2, r - fa), b.stroke(), b.moveTo(l + Z / 2, k + fa), b.lineTo(l - Z / 2, k + fa), b.stroke()));
                        (E[p].indexLabel || x.indexLabel || E[p].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                            chartType: x.type,
                            dataPoint: E[p],
                            dataSeries: x,
                            point: {x: B + (y - B) / 2, y: a.axisY.reversed ? k : r},
                            direction: 1,
                            bounds: {
                                x1: B,
                                y1: Math.min(k, r), x2: y, y2: Math.max(k, r)
                            },
                            color: e
                        })
                    }
        ...
        m.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, l, k,
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var r = a.dataSeriesIndexes[n], q = this.data[r], g = q.dataPoints;
                    if (0 < g.length) for (var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin ||
                        k > a.axisX.dataInfo.viewPortMax) && !t(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                        ...
                        b = P(u);
                        s && ca(this._eventManager.ghostCtx, ka, p, v, l, b, 0, null, !1, !1, !1, !1);
                        if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                            ...
                            dataSeries: q,
                            indexKeyword: 1,
                            point: {x: ka + (v - ka) / 2, y: g[f].y[1] >= g[f].y[0] ? p : l},
        ...
        m.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.rect(p.x1, p.y1, p.width, p.height);
                c.clip();
                s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.clip());
                for (var v =
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var E = a.dataSeriesIndexes[x], C = this.data[E], B = C.dataPoints,
                        y = t(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/ig) && C._linkedSeries.visible ? !0 : !1,
                        D = 0;
                    if (y) for (e = C._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) &&
                    D || (this.data[u].type.match(/(range)/ig) && (f = !0), D++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (y ? v : 1))) << 0 : 0.3 * this.width;
                    f && (l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height /
                        (y ? v : 1))) << 0 : 0.03 * this.width);
                    u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? p.height : p.width) * (a.axisX.logarithmic ? Math.log(ka) / Math.log(a.axisX.range) : Math.abs(ka) / Math.abs(a.axisX.range)) / (y ? v : 1)) << 0;
                    ...
                    u < e && (u = e);
                    u > l && (u = l);
                    if (0 < B.length) for (var F = C._colorSet,
                                               l = 0; l < B.length; l++) {
                        var e = C.lineColor = C.options.color ? C.options.color : F[0], S = {
                            color: B[l].whiskerColor ? B[l].whiskerColor : B[l].color ? C.whiskerColor ? C.whiskerColor : B[l].color : C.whiskerColor ? C.whiskerColor : e,
                            thickness: t(B[l].whiskerThickness) ? C.whiskerThickness : B[l].whiskerThickness,
                            dashType: B[l].whiskerDashType ? B[l].whiskerDashType : C.whiskerDashType,
                            length: t(B[l].whiskerLength) ? t(C.options.whiskerLength) ? u : C.options.whiskerLength : B[l].whiskerLength,
                            trimLength: t(B[l].whiskerLength) ? t(C.options.whiskerLength) ?
                                50 : 0 : 0
                        };
                        S.length = "number" === typeof S.length ? 0 >= S.length ? 0 : S.length >= u ? u : S.length : "string" === typeof S.length ? parseInt(S.length) * u / 100 > u ? u : parseInt(S.length) * u / 100 > u : u;
                        S.thickness = "number" === typeof S.thickness ? 0 > S.thickness ? 0 : Math.round(S.thickness) : 2;
                        var R = {
                            color: B[l].stemColor ? B[l].stemColor : B[l].color ? C.stemColor ? C.stemColor : B[l].color : C.stemColor ? C.stemColor : e,
                            thickness: B[l].stemThickness ? B[l].stemThickness : C.stemThickness,
                            dashType: B[l].stemDashType ? B[l].stemDashType : C.stemDashType
                        };
                        R.thickness =
                            "number" === typeof R.thickness ? 0 > R.thickness ? 0 : Math.round(R.thickness) : 2;
                        B[l].getTime ? m = B[l].x.getTime() : m = B[l].x;
                        if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !t(B[l].y) && B[l].y.length && "number" === typeof B[l].y[0] && "number" === typeof B[l].y[1]) {
                            ...
                            b ? r = ja : g = ja;
                            b ? (q = a.axisX.reversed ? h + (y ? v : 1) * u / 2 - (y ? D - 1 : 0) * u << 0 : h - (y ? v : 1) * u / 2 + (y ? D - 1 : 0) *
                                u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (n = a.axisX.reversed ? k + (y ? v : 1) * u / 2 - (y ? D - 1 : 0) * u << 0 : k - (y ? v : 1) * u / 2 + (y ? D - 1 : 0) * u << 0, r = a.axisX.reversed ? n - u << 0 : n + u << 0);
                            !b && q > g && (ja = q, q = g, g = ja);
                            b && n > r && (ja = n, n = r, r = ja);
                            ja = C.dataPointIds[l];
                            ...
                            w(c, Math.min(n, r), Math.min(q, g), Math.max(r, n), Math.max(g, q), e,
                                S, R, b);
                            s && w(this._eventManager.ghostCtx, n, q, r, g, e, S, R, b);
                            if (B[l].indexLabel || C.indexLabel || B[l].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({
                                chartType: "error",
                                dataPoint: B[l],
                                dataSeries: C,
                                indexKeyword: 0,
        ...
        m.prototype.renderRangeBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var q = a.dataSeriesIndexes[r], g = this.data[q], m = g.dataPoints;
                    if (0 < m.length) {
                        var ka = 5 < n && g.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < m.length; f++) if (m[f].getTime ? h = m[f].x.getTime() : h = m[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !t(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
                            ...
                            b = P(b);
                            s && ca(this._eventManager.ghostCtx,
                            ...
                            if (m[f].indexLabel || g.indexLabel || m[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({
                                ...
                                dataSeries: g,
                                indexKeyword: 0,
                                point: {x: m[f].y[1] >= m[f].y[0] ? p : l, y: k + (v - k) / 2},
        ...
        m.prototype.renderRangeArea = function (a) {
            function d() {
                if (x) {
                    ...
                    x = {x: m, y: t};
                    k = [];
                    k.push({x: m, y1: t, y2: v})
                }
            }

            var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = [], p = this.plotArea;
                b.save();
                s && e.save();
                b.beginPath();
                b.rect(p.x1, p.y1, p.width, p.height);
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var k = [], h = a.dataSeriesIndexes[l],
                        n = this.data[h], r = n.dataPoints, f = n.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: h};
                    f = P(f);
                    e.fillStyle = f;
                    var f = [], q = !0, g = 0, m, t, v, u, x = null;
                    if (0 < r.length) {
                        var E = n._colorSet[g % n._colorSet.length], C = n.lineColor = n.options.lineColor || E, B = C;
                        b.fillStyle = E;
                        b.strokeStyle = C;
                        b.lineWidth = n.lineThickness;
                        var y = "solid";
                        ...
                        for (var S = !0; g < r.length; g++) if (u = r[g].x.getTime ?
                            r[g].x.getTime() : r[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S))) if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                            m = a.axisX.convertValueToPixel(u);
                            t = a.axisY.convertValueToPixel(r[g].y[0]);
                            v = a.axisY.convertValueToPixel(r[g].y[1]);
                            q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || y === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, y = n.nullDataLineDashType,
                                b.setLineDash(w)), b.lineTo(m, t), s && e.lineTo(m, t), k.push({
                                x: m,
                                y1: t,
                                y2: v
                            })) : (b.beginPath(), b.moveTo(m, t), x = {x: m, y: t}, k = [], k.push({
                                x: m,
                                y1: t,
                                y2: v
                            }), s && (e.beginPath(), e.moveTo(m, t))), S = q = !1) : (b.lineTo(m, t), k.push({
                                x: m,
                                y1: t,
                                y2: v
                            }), s && e.lineTo(m, t), 0 == g % 250 && d());
                            u = n.dataPointIds[g];
                            this._eventManager.objectMap[u] = {
                                id: u,
                                objectType: "dataPoint",
                            ...
                            g < r.length - 1 && (B !== (r[g].lineColor || C) || y !== (r[g].lineDashType || n.lineDashType)) && (d(), B = r[g].lineColor || C, k[k.length -
                            1].newStrokeStyle = B, b.strokeStyle = B, b.setLineDash && (r[g].lineDashType ? (y = r[g].lineDashType, k[k.length - 1].newLineDashArray = N(y, n.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (y = n.lineDashType, k[k.length - 1].newLineDashArray = D, b.setLineDash(D))));
        ...
        m.prototype.renderRangeSplineArea = function (a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    d = v(w, 2);
                    b.lineTo(w[w.length - 1].x, w[w.length - 1].y);
                    ...
                    if (0 < h.lineThickness) {
                        ...
                        for (var g = f = 0; f < d.length - 3; f += 3, g++) {
                            if (t[g].newStrokeStyle || t[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), t[g].newStrokeStyle && (b.strokeStyle = t[g].newStrokeStyle), t[g].newLineDashArray &&
                            b.setLineDash(t[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        d = v(t, 2);
                        b.moveTo(d[0].x, d[0].y);
                        for (g = f = 0; f < d.length - 3; f += 3, g++) {
                            if (t[g].newStrokeStyle || t[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), t[g].newStrokeStyle && (b.strokeStyle = t[g].newStrokeStyle), t[g].newLineDashArray && b.setLineDash(t[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        b.stroke()
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                s && (e.beginPath(), e.rect(p.x1, p.y1, p.width, p.height), e.clip());
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var k = a.dataSeriesIndexes[l], h = this.data[k], n = h.dataPoints, f = h.id;
                    ...
                    var f = [], r = 0, q,
                        g, m, t = [], w = [];
                    if (0 < n.length) {
                        var u = h._colorSet[r % h._colorSet.length], x = h.lineColor = h.options.lineColor || u, E = x;
                        b.fillStyle = u;
                        b.lineWidth = h.lineThickness;
                        var C = "solid", B;
                        if (b.setLineDash) {
                            var y = N(h.nullDataLineDashType, h.lineThickness), C = h.lineDashType;
                            B = N(C, h.lineThickness)
                        }
                        for (g = !1; r < n.length; r++) if (q = n[r].x.getTime ? n[r].x.getTime() : n[r].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g))) if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" ===
                            typeof n[r].y[1]) {
                            ...
                            t[t.length] = {x: q, y: g};
                            w[w.length] = {x: q, y: m};
                            r < n.length - 1 && (E !== (n[r].lineColor || x) || C !== (n[r].lineDashType || h.lineDashType)) && (E = n[r].lineColor || x, t[t.length - 1].newStrokeStyle = E, b.setLineDash && (n[r].lineDashType ? (C = n[r].lineDashType,
                                t[t.length - 1].newLineDashArray = N(C, h.lineThickness)) : (C = h.lineDashType, t[t.length - 1].newLineDashArray = B)));
                            if (0 !== n[r].markerSize && (0 < n[r].markerSize || 0 < h.markerSize)) {
                                var F = h.getMarkerProperties(r, q, g, b);
                                f.push(F);
                                var S = P(D);
                                s && f.push({
                                    x: q,
                                ...
                                F = h.getMarkerProperties(r, q, m, b);
                                f.push(F);
                                S = P(D);
                                s && f.push({
                                    x: q,
                            ...
                            g = !1
                        } else 0 < r && !g && (h.connectNullData ? b.setLineDash && (0 < t.length && (h.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (t[t.length -
                        1].newLineDashArray = y, C = h.nullDataLineDashType) : (d(B, x), t = [], w = [])), g = !0;
                        d(B, x);
                        X.drawMarkers(f)
                    }
                }
        ...
        m.prototype.renderWaterfall = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, p = 0, l, k, h, n,
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var m =
                        a.dataSeriesIndexes[g], t = this.data[m], v = t.dataPoints, e = t._colorSet[0];
                    t.risingColor = t.options.risingColor ? t.options.risingColor : e;
                    ...
                    if (0 < v.length) for (var E = 5 < q && t.bevelEnabled ? !0 : !1, C = !1, B = null, y = null, p = 0; p < v.length; p++) if (v[p].getTime ? n = v[p].x.getTime() : n = v[p].x, "number" !== typeof v[p].y) {
                        if (0 < p && !C && t.connectNullData) var w =
                            t.options.nullDataLineDashType || !v[p - 1].lineDashType ? t.nullDataLineDashType : v[p - 1].lineDashType;
                        C = !0
                    } else {
                        l = a.axisX.convertValueToPixel(n);
                        k = 0 === t.dataPointEOs[p].cumulativeSum ? r : a.axisY.convertValueToPixel(t.dataPointEOs[p].cumulativeSum);
                        h = 0 === t.dataPointEOs[p].cumulativeSumYStartValue ? r : a.axisY.convertValueToPixel(t.dataPointEOs[p].cumulativeSumYStartValue);
                        ...
                        var S = v[p].color ? v[p].color : 0 < v[p].y ? t.risingColor : t.fallingColor;
                        ca(c, l, k, D, h, S, 0, S, E, E, !1, !1, t.fillOpacity);
                        e = P(e);
                        s && ca(this._eventManager.ghostCtx, l, k, D, h, e, 0, null, !1, !1, !1, !1);
                        var R, S = l;
                        ...
                        0 < p && B && (!C || t.connectNullData) && (C && c.setLineDash && c.setLineDash(N(w, u)), c.beginPath(), c.moveTo(B, y - x), c.lineTo(S, R - x), 0 < u && c.stroke(), s && (b.beginPath(), b.moveTo(B, y - x), b.lineTo(S, R - x), 0 < u && b.stroke()));
                        C = !1;
                        B = D;
                        y = 0 < v[p].y ? k : h;
                        S = v[p].lineDashType ? v[p].lineDashType : t.options.lineDashType ? t.options.lineDashType : "shortDash";
                        c.strokeStyle = v[p].lineColor ? v[p].lineColor : t.options.lineColor ? t.options.lineColor : "#9e9e9e";
                        c.lineWidth =
                            u;
                        c.setLineDash && (S = N(S, u), c.setLineDash(S));
                        (v[p].indexLabel || t.indexLabel || v[p].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "waterfall",
                            dataPoint: v[p],
                            dataSeries: t,
                            point: {x: l + (D - l) / 2, y: 0 <= v[p].y ? k : h},
                            direction: 0 > v[p].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: l, y1: Math.min(k, h), x2: D, y2: Math.max(k, h)},
                            color: e
                        })
                    }
                }
        ...
        m.prototype.renderPie = function (a) {
            function d() {
                if (h &&
                    ...
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        var f = n[e], p = h.dataPointIds[e];
                        g[e].id = p;
                        g[e].objectType = "dataPoint";
                        g[e].dataPointIndex = e;
                        g[e].dataSeriesIndex = 0;
                        var l = g[e], r = {percent: null, total: null}, m = null, r = k.getPercentAndTotal(h, f);
                        ...
                        l.indexLabelLineThickness = t(f.indexLabelLineThickness) ? h.indexLabelLineThickness : f.indexLabelLineThickness;
                        ...
                        l.indexLabelFontSize = t(f.indexLabelFontSize) ? h.indexLabelFontSize : f.indexLabelFontSize;
                        ...
                        l.endAngle = l.startAngle + 2 * Math.PI / w * Math.abs(f.y);
                    ...
                    p = f = 0;
                    r = !1;
                    for (e = 0; e < n.length; e++) l = g[(c + e) % n.length], 1 < a && (l.midAngle > Math.PI / 2 - u && l.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !r ? (l.hemisphere = "right",
                        f++) : (l.hemisphere = "left", r = !0));
                    r = !1;
                    for (e = 0; e < n.length; e++) l = g[(d + e) % n.length], 1 < b && (l.midAngle > 3 * Math.PI / 2 - u && l.midAngle < 3 * Math.PI / 2 + u) && (p <= b / 2 && !r ? (l.hemisphere = "left", p++) : (l.hemisphere = "right", r = !0))
                }
            }
            ...
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        if (n[b].exploded) {
                            if (1E-9 <
                                Math.abs(g[b].center.x - (E.x + e)) || 1E-9 < Math.abs(g[b].center.y - (E.y + f))) g[b].center.x = E.x + e * a, g[b].center.y = E.y + f * a, l = !0
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    l = 0;
                    l = "right" === k.hemisphere ? E.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - E.y, 2)) : E.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - E.y, 2));
                    r = E.x + y * Math.cos(k.midAngle);
                    q = E.y + y * Math.sin(k.midAngle);
                    q = Math.sqrt(Math.pow(l - r, 2) + Math.pow(c -
                        q, 2));
                    r = Math.acos(y / s);
                    q = Math.acos((s * s + y * y - q * q) / (2 * y * s));
                    ...
                    h && (d = k.indexLabelTextBlock.y + h, c = 0, c =
                        "right" === k.hemisphere ? E.x + Math.sqrt(Math.pow(s, 2) - Math.pow(d - E.y, 2)) : E.x - Math.sqrt(Math.pow(s, 2) - Math.pow(d - E.y, 2)), k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (l = (a - 1 + g.length) % g.length, l = g[l], a = g[(a + 1 + g.length) % g.length], "left" === k.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x - 15 : "right" === k.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : k.midAngle > 3 * Math.PI / 2 - u && k.midAngle < 3 * Math.PI / 2 + u && (l = (a - 1 + g.length) %
                        g.length, l = g[l], a = g[(a + 1 + g.length) % g.length], "right" === k.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x + 15 : "left" === k.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)), k.indexLabelTextBlock.y = d, k.indexLabelTextBlock.x = c, k.indexLabelAngle = Math.atan2(k.indexLabelTextBlock.y - E.y, k.indexLabelTextBlock.x - E.x))
                }
                return h
            }
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== h.indexLabelPlacement) {
                        ...
                        for (a = 0; a < n.length; a++) {
                            var p = g[a];
                            p.indexLabelTextBlock.x = E.x + s * Math.cos(p.midAngle);
                            p.indexLabelTextBlock.y = E.y + s * Math.sin(p.midAngle);
                            p.indexLabelAngle = p.midAngle;
                            p.radius = y;
                            p.percentInnerRadius = F
                        }
                        for (var t, u, a = 0; a < n.length; a++) {
                            var p = g[a], B = e(a);
                            if (null !== B) {
                                t = g[a];
                                u = g[B];
                                var w = 0, w = b(t, u) -
                                    m;
                                if (0 > w) {
                                    for (var C = u = 0, J = 0; J < n.length; J++) J !== a && g[J].hemisphere === p.hemisphere && (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y ? u++ : C++);
                                    u = w / (u + C || 1) * C;
                                    var C = -1 * (w - u), I = J = 0;
                                    "right" === p.hemisphere ? (J = f(a, u), C = -1 * (w - J), I = f(B, C), +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +u.toFixed(x) && f(a, -(C - I))) : (J = f(B, u), C = -1 * (w - J), I = f(a, C), +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +u.toFixed(x) && f(B, -(C - I)))
                                }
                            }
                        }
                    } else for (a = 0; a < n.length; a++) p = g[a], s = "pie" === h.type ? 0.7 * y : 0.8 * y, B = E.x + s * Math.cos(p.midAngle),
                        u = E.y + s * Math.sin(p.midAngle), p.indexLabelTextBlock.x = B, p.indexLabelTextBlock.y = u;
                    for (a = 0; a < n.length; a++) if (p = g[a], B = p.indexLabelTextBlock.measureText(), 0 !== B.height && 0 !== B.width) B = B = 0, "right" === p.hemisphere ? (B = q.x2 - (p.indexLabelTextBlock.x + p.indexLabelTextBlock.width + r), B *= -1) : B = q.x1 - (p.indexLabelTextBlock.x - p.indexLabelTextBlock.width - r), 0 < B && (!l && p.indexLabelText && (u = "right" === p.hemisphere ? q.x2 - p.indexLabelTextBlock.x : p.indexLabelTextBlock.x - q.x1, 0.3 * p.indexLabelTextBlock.maxWidth > u ? p.indexLabelText =
                        "" : p.indexLabelTextBlock.maxWidth = 0.85 * u, 0.3 * p.indexLabelTextBlock.maxWidth < u && (p.indexLabelTextBlock.x -= "right" === p.hemisphere ? 2 : -2)), Math.abs(p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - E.y) < y || Math.abs(p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 - E.y) < y) && (B /= Math.abs(Math.cos(p.indexLabelAngle)), 9 < B && (B *= 0.3), B > d && (d = B)), B = B = 0, 0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? (B = q.y2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + 5), B *= -1) : B = q.y1 - (p.indexLabelTextBlock.y -
                        p.indexLabelTextBlock.height / 2 - 5), 0 < B && (!l && p.indexLabelText && (u = 0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, B * u) && f(a, 2 * u)), Math.abs(p.indexLabelTextBlock.x - E.x) < y && (B /= Math.abs(Math.sin(p.indexLabelAngle)), 9 < B && (B *= 0.3), B > d && (d = B)));
                        ...
                        for (var a = -1, c = -1, d = 0, f = !1, h = 0; h < n.length; h++) if (f = !1, t = g[h], t.indexLabelText) {
                            ...
                            if (null !== p) {
                                ...
                                if (k = 0 > w) {
                                    ...
                                    var q = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2,
                                        m = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height / 2,
                                        u = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2,
                                        z = l.indexLabelTextBlock.x + l.indexLabelTextBlock.width,
                                        A = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2;
                                    k = t.indexLabelTextBlock.x +
                                    t.indexLabelTextBlock.width < l.indexLabelTextBlock.x - r || k > z + r || q > A + r || m < u - r ? !1 : !0
                                }
                                k ? (0 > a && (a = h), p !== a && (c = p, d += -w), 0 === h % Math.max(n.length / 10, 3) && (f = !0)) : f = !0;
            ...
            var k = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this.data[a.dataSeriesIndexes[0]], n = h.dataPoints, r = 10, q = this.plotArea,
                    g = h.dataPointEOs, m = 2, s, v = 1.3, u = 20 / 180 * Math.PI, x = 6,
                    E = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, w = 0;
                a = !1;
                for (var B = 0; B < n.length; B++) w += Math.abs(n[B].y), !a && ("undefined" !== typeof n[B].indexLabel &&
                ...
                if (0 !== w) {
                    ...
                    h.radius && (y = Qa(h.radius, y));
                    var D = "undefined" !== typeof h.innerRadius && null !== h.innerRadius ? Qa(h.innerRadius, y) : 0.7 * y;
                    h.radius =
                        y;
                    "doughnut" === h.type && (h.innerRadius = D);
                    var F = Math.min(D / y, (y - 1) / y);
                    this.pieDoughnutClickHandler = function (a) {
                        k.isAnimating || !t(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && k._animator.animate(0, 500, function (a) {
                            c(a);
                            l()
                        }))
                    };
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function b() {
                if (u && x) {
                    for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, z = [], A = [], v = {
                        percent: null,
                        total: null
                    }, B = null, y = 0; y < x.length; y++) m = O[y], m = "undefined" !== typeof m.x5 ?
                        (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2, m = g(m).x2 + 1, z[y] = M - m - V;
                    m = 0.5 * V;
                    for (var y = 0, E = x.length - 1; y < x.length || 0 <= E; y++, E--) {
                        b = u.reversed ? x[E] : x[y];
                        ...
                        d = b.indexLabelBackgroundColor || u.indexLabelBackgroundColor || (s ? "transparent" : null);
                        e = b.indexLabelFontColor || u.indexLabelFontColor || "#979797";
                        f = t(b.indexLabelFontSize) ? u.indexLabelFontSize : b.indexLabelFontSize;
                        ...
                        typeof u.indexLabelWrap ? u.indexLabelWrap : !0;
                        r = u.dataPointIds[y];
                        w._eventManager.objectMap[r] = {
                            id: r,
                            objectType: "dataPoint",
                            dataPointIndex: y,
                            dataSeriesIndex: 0,
                        ...
                        "inside" === u.indexLabelPlacement && (z[y] = y !== ca ? u.reversed ? O[y].x2 - O[y].x1 : O[y].x3 - O[y].x4 : O[y].x3 - O[y].x6, 20 > z[y] && (z[y] = y !== ca ? u.reversed ? O[y].x3 - O[y].x4 : O[y].x2 - O[y].x1 : O[y].x2 - O[y].x1, z[y] /= 2));
                        r = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : z[y];
                        if (r >
                            z[y] || 0 > r) r = z[y];
                        A[y] = "inside" === u.indexLabelPlacement ? O[y].height : !1;
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(B) : b.indexLabel ? w.replaceKeywordsWithValue(b.indexLabel, b, u, y) : u.indexLabelFormatter ? u.indexLabelFormatter(B) : u.indexLabel ? w.replaceKeywordsWithValue(u.indexLabel, b, u, y) : b.label ? b.label : "";
                        0 >= k && (k = 0);
                        ...
                        c = new ia(P, {
                            ...
                            backgroundColor: d,
                            maxWidth: r,
                            maxHeight: !1 === A[y] ? q ? 4.28571429 * f : 1.5 * f : A[y],
                            text: b,
                            padding: da
                        });
                        c.measureText();
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, h = M - $ - V / 2, h = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth >
                h ? h : u.indexLabelMaxWidth : h, l = H.length - 1; 0 <= l; l--) {
                    g = x[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                ...
                if (e) for (l = H.length - 1; 0 <= l; l--) a = O[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(), H[l].textBlock.x = M - h, c = H[l].textBlock.height < H[l].textBlock.maxHeight ? H[l].textBlock.height : H[l].textBlock.maxHeight, e = H[l].textBlock.width < H[l].textBlock.maxWidth ? H[l].textBlock.width :
                    H[l].textBlock.maxWidth, H[l].height = c, H[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, H[l].textBlock.y = c - H[l].height / 2, u.reversed ? (H[l].textBlock.y + H[l].height > T + C && (H[l].textBlock.y = T + C - H[l].height), H[l].textBlock.y < ra - C && (H[l].textBlock.y = ra - C)) : (H[l].textBlock.y < T - C && (H[l].textBlock.y = T - C), H[l].textBlock.y + H[l].height > ra + C && (H[l].textBlock.y = ra + C - H[l].height))
            }

            function f() {
                var a, b, c, d;
                if ("inside" !== u.indexLabelPlacement) for (var e = 0; e < O.length; e++) 0 == H[e].textBlock.text.length ?
                    H[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > wa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < wa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y = c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > T + C && (H[e].textBlock.y = T + C - H[e].height), H[e].textBlock.y < ra - C && (H[e].textBlock.y = ra - C)) : (H[e].textBlock.y < T - C && (H[e].textBlock.y = T - C), H[e].textBlock.y + H[e].height > ra + C &&
                    (H[e].textBlock.y = ra + C - H[e].height))); else for (e = 0; e < O.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0)
            }
            ...
            function p() {
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++) if (b =
                        e[d], f < a) g++, f += H[b.id].height + da, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText(); else break;
                    return g
                }
            ...
            function l(a, b) {
                return (b < O.length ? H[b].textBlock.y :
                    u.reversed ? T + C : ra + C) - (0 > a ? u.reversed ? ra - C : T - C : H[a].textBlock.y + H[a].height + da)
            }
            ...
            function k(a, b, c) {
                ...
                a._animator.animate(0, c, function (c) {
                    ...
                    ha = !0;
                    d.clearRect(E.x1, E.y1, E.x2 - E.x1,
                        E.y2 - E.y1);
                    ...
                    v(d);
                    I && ("inside" !== u.indexLabelPlacement ? n(d) : f(), m(d));
                    1 <= c && (ha = !1)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]],
                         x = u.dataPoints, E = this.plotArea, C = 0.025 * E.width, B = 0.01 * E.width, y = 0, D = E.height - 2 * C, F = Math.min(E.width - 2 * B, 2.8 * E.height), I = !1, R = 0; R < x.length; R++) if (!I && ("undefined" !== typeof x[R].indexLabel && null !== x[R].indexLabel && 0 < x[R].indexLabel.toString().length) && (I = !0), !I && ("undefined" !== typeof x[R].label && null !== x[R].label && 0 < x[R].label.toString().length) && (I = !0), !I && "function" === typeof u.indexLabelFormatter || "function" === typeof x[R].indexLabelFormatter) I = !0;
                I = I || "undefined" !== typeof u.indexLabel && null !== u.indexLabel &&
                    0 < u.indexLabel.toString().length;
                "inside" !== u.indexLabelPlacement && I || (B = (E.width - 0.75 * F) / 2);
                var R = E.x1 + B, M = E.x2 - B, Z = E.y1 + C, Q = E.y2 - C,
                    P = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    var ba, G;
                    a = 75 * F / 100;
                    var V = 30 * (M - a) / 100;
                    "funnel" === u.type ? (ba = t(u.options.neckHeight) ? 0.35 * D : u.neckHeight, G = t(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * D / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ?
                        (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > D ? ba = D : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === u.type && (G = ba = 0, u.reversed = u.reversed ? !1 : !0);
                    var B = R + a / 2, W = R, $ = R + a, T = u.reversed ? Q : Z, K = B - G / 2, X = B + G / 2,
                        wa = u.reversed ? Z + ba : Q - ba, ra = u.reversed ? Z : Q;
                    a = [];
                    var B = [], O = [], F = [], U = Z, ca, aa = (wa - T) / (K - W), ea = -aa,
                        R = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== R) {
                        if (u.reversed) for (F.push(U), G = R.length - 1; 0 < G; G--) U += R[G], F.push(U); else for (G = 0; G < R.length; G++) U += R[G], F.push(U);
                        if (u.reversed) for (G =
                                                 0; G < R.length; G++) F[G] < wa ? (a.push(K), B.push(X), ca = G) : (a.push((F[G] - T + aa * W) / aa), B.push((F[G] - T + ea * $) / ea)); else for (G = 0; G < R.length; G++) F[G] < wa ? (a.push((F[G] - T + aa * W) / aa), B.push((F[G] - T + ea * $) / ea), ca = G) : (a.push(K), B.push(X));
                        for (G = 0; G < R.length - 1; G++) U = u.reversed ? x[x.length - 1 - G].color ? x[x.length - 1 - G].color : u._colorSet[(x.length - 1 - G) % u._colorSet.length] : x[G].color ? x[G].color : u._colorSet[G % u._colorSet.length], G === ca ? O.push({
                            x1: a[G],
                            y1: F[G],
                            x2: B[G],
                            y2: F[G],
                        ...
                        var da = 2, H = [], ha = !1, Y = [], ga = [], R = !1;
                        a = a = 0;
                        Ba(Y);
                        for (G = 0; G < x.length; G++) x[G].exploded && (R = !0, u.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
                        P.clearRect(E.x1, E.y1, E.width, E.height);
                        P.fillStyle = w.backgroundColor;
                        P.fillRect(E.x1, E.y1, E.width, E.height);
                        if (I && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                            p();
                            for (G = 0; G < x.length; G++) H[G].isDirty ||
                            (a = H[G].textBlock.x + H[G].width, a = (M - a) / 2, 0 == G && (y = a), y > a && (y = a));
                            for (G = 0; G < O.length; G++) O[G].x1 += y, O[G].x2 += y, O[G].x3 += y, O[G].x4 += y, O[G].x5 && (O[G].x5 += y, O[G].x6 += y), H[G].textBlock.x += y
                        }
                        for (G = 0; G < O.length; G++) y = O[G], pa(P, y, u.fillOpacity), ga.push(y.y1);
                        v(P);
                        I && u.visible && ("inside" === u.indexLabelPlacement || w.animationEnabled || n(P), w.animationEnabled || m());
                        if (!I) for (G = 0; G < x.length; G++) y = u.dataPointIds[G], a = {
                            id: y,
                            objectType: "dataPoint",
                            dataPointIndex: G,
                            dataSeriesIndex: 0,
                            funnelSection: O[u.reversed ? x.length -
                                1 - G : G]
                        }, w._eventManager.objectMap[y] = a;
                        !w.animationEnabled && R ? k(w, -1, 0) : w.animationEnabled && !w.animatedRender && k(w, -1, 0);
                        this.funnelPyramidClickHandler = function (a) {
                            var b = -1;
                            if (!ha && !w.isAnimating && (t(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                a = b;
        ...
        m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") ||
                ...
                var p = "#percent", l = "#total", k = this.getPercentAndTotal(c, d), l = isNaN(k.total) ? l : k.total,
                    p = isNaN(k.percent) ? p : k.percent;
                do {
                    k = "";
                    if (c.percentFormatString) k = c.percentFormatString; else {
                        var k = "#,##0.", h = Math.max(Math.ceil(Math.log(1 / Math.abs(p)) / Math.LN10), 2);
        ...
        F.prototype.setLayout = function () {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(),
                c = null, b = 0, e = 0, f = 0, p = 0,
                l = this.markerMargin = this.chart.options.legend && !t(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
            this.height = 0;
            var k = [], h = [];
            "top" === this.verticalAlign ||
            ...
            for (var n = 0; n < this.dataSeries.length; n++) {
                ...
                if (r.dataPoints && r.dataPoints.length) if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                    var q = r.legendMarkerType = r.legendMarkerType ? r.legendMarkerType : "line" !== r.type && "stepLine" !== r.type && "spline" !== r.type && "scatter" !== r.type && "bubble" !== r.type || !r.markerType ? "error" === r.type && r._linkedSeries ? r._linkedSeries.legendMarkerType ? r._linkedSeries.legendMarkerType : I.getDefaultLegendMarker(r._linkedSeries.type) : I.getDefaultLegendMarker(r.type) : r.markerType,
                        ...
                        m = r.legendMarkerColor = r.legendMarkerColor ? r.legendMarkerColor : r.markerColor ? r.markerColor : "error" === r.type ? t(r.whiskerColor) ? r._colorSet[0] : r.whiskerColor : r._colorSet[0],
                        s = r.markerSize || "line" !== r.type && "stepLine" !== r.type && "spline" !== r.type ? 0.75 * this.lineHeight : 0,
                        v = r.legendMarkerBorderColor ? r.legendMarkerBorderColor : r.markerBorderColor,
                        u = r.legendMarkerBorderThickness ? r.legendMarkerBorderThickness :
                            r.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0;
                    ...
                    var w = r.dataPoints[x],
                        q = w.legendMarkerType ? w.legendMarkerType : r.legendMarkerType ? r.legendMarkerType :
                            I.getDefaultLegendMarker(r.type),
                        g = w.legendText ? w.legendText : r.legendText ? r.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart,
                            legend: this.options,
                            dataSeries: r,
                            dataPoint: w
                        }) : w.name ? w.name : "DataPoint: " + (x + 1),
                        m = w.legendMarkerColor ? w.legendMarkerColor : r.legendMarkerColor ? r.legendMarkerColor : w.color ? w.color : r.color ? r.color : r._colorSet[x % r._colorSet.length],
                        s = 0.75 * this.lineHeight,
                        v = w.legendMarkerBorderColor ? w.legendMarkerBorderColor : r.legendMarkerBorderColor ? r.legendMarkerBorderColor :
                            w.markerBorderColor ? w.markerBorderColor : r.markerBorderColor,
                        u = w.legendMarkerBorderThickness ? w.legendMarkerBorderThickness : r.legendMarkerBorderThickness ? r.legendMarkerBorderThickness : w.markerBorderThickness || r.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0,
                        g = this.chart.replaceKeywordsWithValue(g, w, r, x), q = {
                            markerType: q,
                            markerColor: m,
                            text: g,
                            textBlock: null,
                    ...
                    (w.showInLegend || r.showInLegend &&
                        !1 !== w.showInLegend) && k.push(q)
                }
            }
                ...
                for (n = 0; n < k.length; n++) {
                    ...
                    if (!(0 >= p || "undefined" ===
                        ...
                        if ("horizontal" === this.orientation) {
                            ...
                            null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (s + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" ===
                            q.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                            if (!r || r.width + Math.round(q.textBlock.width + s + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) r = {
                                items: [],
                                width: 0
                            ...
                            fontStyle: this.fontStyle,
                            textBaseline: "middle"
                        }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (s + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < p - this.lineHeight ? (r = {
                            items: [],
                            width: 0
                        }, h.push(r)) : (r = h[x], x = (x + 1) % h.length), this.height += q.textBlock.height;
                        q.textBlock.x = r.width;
                        q.textBlock.y = 0;
                        r.width += Math.round(q.textBlock.width + s + l + (0 === r.width ?
                        ...
                        m = q.textBlock.width + (s + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                    }
                }
                this.itemWidth = m;
        ...
        F.prototype.render = function () {
            ...
            for (var l = 0, k = 0; k < p.length; k++) {
                for (var h = p[k], n = 0, r = 0; r < h.items.length; r++) {
                    var q = h.items[r], g = q.textBlock.x + a + (0 === r ? 0.2 * f : this.horizontalSpacing), m = d + l,
                        t = g;
                    ...
                    this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, m + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, m + this.lineHeight / 2), this.ctx.stroke(), t -= 0.1 * this.lineHeight;
                    if ("error" === q.chartType) {
                        this.ctx.strokeStyle = this.errorMarkerColor[0];
                        this.ctx.lineWidth = f / 8;
                        this.ctx.beginPath();
                        var s = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                            u = m + 0.15 * this.lineHeight, x = 0.7 * this.lineHeight, v = x + 0.02 * this.lineHeight;
                        this.ctx.moveTo(s, u);
                        this.ctx.lineTo(s + x, u);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(s + x / 2, u);
                        this.ctx.lineTo(s + x / 2, u + v);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(s, u + v);
                        this.ctx.lineTo(s + x, u + v);
                        this.ctx.stroke();
                    ...
                    this.ghostCtx.fillRect(t, q.textBlock.y - this.lineHeight /
                        2, q.textBlock.x + q.textBlock.width - t, q.textBlock.height);
        ...
        I.prototype.getDataPointAtX = function (a, d) {
            ...
            var c = {dataPoint: null, distance: Infinity, index: NaN}, b = null, e = 0, f = 0, p = 1, l = Infinity,
                k = 0, h = 0, n = 0;
        ...
        I.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            c = c || !1;
            var b = [], e = 0, f = 0, p = 1, l = !1, k = Infinity, h = 0, n = 0, r = 0;
            if ("none" !== this.chart.plotInfo.axisPlacement) if (r = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
                x: a,
                y: d
            }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                r = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(r / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, r = 0 < q ? Math.min(Math.max((this.dataPoints.length -
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "splineArea":
                            case "scatter":
                                var t = la("markerSize", g, this) || 4, s = c ? 20 : t,
                                    m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                                m <= s && b.push({dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m});
                                q = Math.abs(q.x1 - a);
                                q <= k ? k = q : 0 < p ? h++ : n++;
                                m <= t / 2 && (l = !0);
                                break;
                            ...
                            case "doughnut":
                                t = q.center;
                                s = "doughnut" === this.type ? q.percentInnerRadius * q.radius :
                                    0;
                                m = Math.sqrt(Math.pow(t.x - a, 2) + Math.pow(t.y - d, 2));
                                m < q.radius && m > s && (m = Math.atan2(d - t.y, a - t.x), 0 > m && (m += 2 * Math.PI), m = Number(((180 * (m / Math.PI) % 360 + 360) % 360).toFixed(12)), t = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === s && 1 < q.endAngle && (s = 360), t >= s && 0 !== g.y && (s += 360, m < t && (m += 360)), m > t && m < s && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
        ...
        D.prototype.createLabels = function () {
            ...
            var r = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
                q = r.length ? t(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0;
            ...
            e = [];
            q = r = 0;
            if (this.labelAutoFit || this.options.labelAutoFit) if (t(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (f = 0.9 * l >> 0, q = 0, !this.chart.panEnabled && 1 <=
            this._labels.length) {
                ...
                for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
                    ...
                    if (t(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (h - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !t(this.options.labelWrap)) this.labelWrap ? t(this.options.labelMaxWidth) ?
                        ...
                        if (t(this.options.labelWrap)) if (!t(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ?
                        ...
                        this.options.labelMaxWidth : n) : (t(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : n, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = p)
                }
                ...
                a.measureText(); else if ("left" === this._position || "right" === this._position) if (f = t(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, p = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                this.sessionVariables.labelFontSize = this.labelFontSize;
                this.sessionVariables.labelMaxWidth = f;
                this.sessionVariables.labelMaxHeight = p;
                this.sessionVariables.labelAngle = t(this.sessionVariables.labelAngle) ?
                ...
                for (c = 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
                    ...
                    t(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? t(this.options.labelWrap) ? t(this.options.labelWrap) && (t(this.options.labelMaxWidth) ? t(d) || (l = m.height + d.height >> 0, l - 2 * p > q && (q = l - 2 * p, l >= 2 * p && l < 2.4 * p ? (t(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelFontSize =
                        ...
                        this.labelWrap, this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = p, t(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap)
                }
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position) w = t(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position) w = t(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight :
                        f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                    t(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE")
                } else p = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, w = t(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, t(f.labelBackgroundColor) && (t(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = s ? "transparent" : null : f.labelBackgroundColor =
                    "#EEEEEE");
                a = new ia(this.ctx, {
                    x: 0,
                    y: 0,
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            if (a && 0 < a.length) for (var g = 0; g < a.length; g++) a[g] &&
            ...
            for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var m = q[g].scaleBreaks._appliedBreaks, s = 0; s < m.length && !(m[s].startValue > q[g].viewportMaximum); s++) m[s].endValue < q[g].viewportMinimum || (t(q[g].scaleBreaks.firstBreakIndex) &&
            (q[g].scaleBreaks.firstBreakIndex = s), m[s].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = s));
            for (var v = s = 0, u = 0, x = 0, w = 0, C = 0, B = 0, y, D, F = l = 0, I, J, L, m = I = J = L = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var x = [], w = [], C = [], B = [], M = [], N = [], P = [], Q = []; 4 > s;) {
                    var G = 0, V = 0, T = 0, W = 0, Y = e = 0, K = 0, $ = 0, U = 0, X = 0, O = 0, aa = 0;
                    if (c && 0 < c.length) for (C = [], g = O = 0; g < c.length; g++) C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += C[g], K += c[g] && !n.isNavigator ? c[g].margin : 0; else C.push(Math.ceil(c[0] ?
                    ...
                    if (a && 0 < a.length) for (x = [], g = U = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(k - p), a[g].title && (a[g]._titleTextBlock.maxWidth =
                        0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ? a[g].titleMaxWidth : a[g].lineCoordinates.width), x.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), U += x[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                    M.push(x);
                    if (d && 0 < d.length) for (w = [], g = X = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(k - p), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth <
                    d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), X += w[g], Y += d[g] && !n.isNavigator ? d[g].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    N.push(w);
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = p, k = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), a[g]._labels && 1 < a[g]._labels.length && (l = h = 0, h = a[g]._labels[1], l = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length -
                    2] : a[g]._labels[a[g]._labels.length - 1], v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), u = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))), !a[g] || (!a[g].labelAutoFit || t(y) || t(D) || n.isNavigator || n.stockChart) || (l = 0, 0 < a[g].labelAngle ? D + u > k && (l += 0 < a[g].labelAngle ? D + u - k - aa : 0) :
                        0 > a[g].labelAngle ? y - v < p && y - v < a[g].viewportMinimum && (F = p - (K + a[g].tickLength + C + y - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (D + u > k && (l = D + u / 2 - k - aa), y - v < p && y - v < a[g].viewportMinimum && (F = p - K - a[g].tickLength - C - y + v / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < l ? k -= l : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < F ? p += F : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle &&
                        (0 < F && (p += F), 0 < l && (k -= l))), n.panEnabled ? U = t(n.sessionVariables.axisX.height) ? n.sessionVariables.axisX.height = U : n.sessionVariables.axisX.height : n.sessionVariables.axisX.height = U, l = Math.round(f.y2 - U - e + G), h = Math.round(f.y2), a[g].lineCoordinates.x2 = k, a[g].lineCoordinates.width = k - p, a[g].lineCoordinates.y1 = l, a[g].lineCoordinates.y2 = l + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + x[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" ===
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(k - p), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], l = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length -
                    2] : d[g]._labels[d[g]._labels.length - 1], v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), u = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))), n.panEnabled ? X = t(n.sessionVariables.axisX2.height) ? n.sessionVariables.axisX2.height = X : n.sessionVariables.axisX2.height : n.sessionVariables.axisX2.height =
                        X, l = Math.round(f.y1), h = Math.round(f.y2 + d[g].margin), d[g].lineCoordinates.y1 = l + X + Y - V, d[g].lineCoordinates.y2 = l, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - w[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)), d[g].bounds = {
                        x1: p,
                        y1: l + (X + Y - w[g] - V),
                        x2: k,
                        y2: h,
                    ...
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) K = n.isNavigator ? 0 : 10, c[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ?
                        ...
                        y2: h,
                        height: Math.abs(h - l)
                    }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (C[g] - c[g]._titleTextBlock ? c[g]._titleTextBlock.height :
                        ...
                        width: k - p,
                        height: h - l
                    }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), T += C[g] + c[g].margin);
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(p), K =
                    ...
                    if (0 <
                        s) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) m = M[s - 1][g] === M[s][g] ? !0 : !1; else m = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = N[s - 1][g] === N[s][g] ? !0 : !1; else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = P[s - 1][g] === P[s][g] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = Q[s - 1][g] === Q[s][g] ? !0 : !1; else L = !0
                    }
                    if (m && I && J && L) break;
                    s++
                }
                ...
                for (N = []; 4 > s;) {
                    ...
                    if (a && 0 < a.length) for (F = [], g = W = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), W += F[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else F.push(Math.ceil(a[0] ?
                        a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length) for (v = [], g = U = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), U += v[g], Y += d[g] ? d[g].margin : 0; else v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                    N.push(v);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, p = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > n.width - 10 ? n.width - 10 : f.x2 - U - Y), c[g].labelAutoFit && !t(x) && (0 < !a.length && (p = 0 > c[g].labelAngle ? Math.max(p, x) : 0 === c[g].labelAngle ?
                        Math.max(p, x / 2) : p), 0 < !d.length && (k = 0 < c[g].labelAngle ? k - w / 2 : 0 === c[g].labelAngle ? k - w / 2 : k)), c[g].lineCoordinates.x1 = p, c[g].lineCoordinates.x2 = k, c[g].lineCoordinates.width = Math.abs(k - p), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, p = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - Y), b[g] &&
                    ...
                    if (c && 0 < c.length) for (r = [], g = T = 0; g < c.length; g++) r.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), T +=
                        r[g] + c[g].margin, K += c[g].margin; else r.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    D.push(r);
                    if (b && 0 < b.length) for (y = [], g = V = 0; g < b.length; g++) y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), V += y[g], $ += b[g].margin; else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(y);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (h = c[g]._labels[0], l = c[g]._labels[c[g]._labels.length - 1], x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) +
                        (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), w = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle)));
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0], l = b[g]._labels[b[g]._labels.length - 1], C = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI /
                    ...
                    if (n.panEnabled) for (g = 0; g < c.length; g++) r[g] = t(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = r[g] : n.sessionVariables.axisY.height; else for (g = 0; g < c.length; g++) n.sessionVariables.axisY.height = r[g];
                    if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--) l = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ?
                    ...
                    if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) b[g] && (l = Math.round(f.y1), h = Math.round(f.y1 + (y[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - y[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                        x1: p,
                        y1: l + (b[g].margin + G),
                        x2: k,
                        y2: h,
                        ...
                        0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), G += y[g] + b[g].margin);
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                        ...
                        if (c && 0 < c.length) for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - W : p);
                        if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x1, p = k - W);
                        a[g].lineCoordinates = {x1: k - P, y1: l, x2: k - P, y2: h, height: Math.abs(h - l)};
                        "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 =
                            a[g].lineCoordinates.x1 - (F[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + ("outside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2);
                        a[g].bounds = {x1: k - (F[g] + P), y1: l, x2: k, y2: h, width: k - p, height: h - l};
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                        ...
                        if (c &&
                            0 < c.length) for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : p);
                        if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2, p = k - U);
                    ...
                    if (0 < s) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) m = M[s - 1][g] === M[s][g] ? !0 : !1; else m = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = N[s - 1][g] === N[s][g] ? !0 : !1; else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = D[s - 1][g] === D[s][g] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = u[s - 1][g] === u[s][g] ? !0 : !1; else L = !0
                    }
                    if (m && I && J && L) break;
                    s++
                }
                if (c && 0 < c.length) for (g = 0; g < c.length; g++) c[g].calculateStripLinesThicknessInValues(), c[g].calculateBreaksInPixels();
                if (b &&
                    0 < b.length) for (g = 0; g < b.length; g++) b[g].calculateStripLinesThicknessInValues(), b[g].calculateBreaksInPixels();
                if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g].calculateStripLinesThicknessInValues(), a[g].calculateBreaksInPixels();
            ...
            for (var a = 0; a < this.stripLines.length; a++) if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
                var d = Math.min(this.stripLines[a].startValue, this.stripLines[a].endValue),
                    c = Math.max(this.stripLines[a].startValue,
                        this.stripLines[a].endValue), d = this.getApparentDifference(d, c);
        ...
        D.prototype.calculateBreaksInPixels = function () {
            if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                ...
                (t(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d), a[d].startValue >= this.conversionParameters.minimum && (a[d].startPixel = this.convertValueToPixel(a[d].startValue), this.scaleBreaks.lastBreakIndex = d), a[d].endValue <= this.conversionParameters.maximum && (a[d].endPixel = this.convertValueToPixel(a[d].endValue)))
            }
        };
        D.prototype.renderLabelsTicksAndTitle = function () {
            ...
            if ("undefined" === typeof this.options.interval) {
                ...
                if ("left" === this._position || "right" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c =
                        [], n, l = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                        r = this._labels[h];
                        if (r.position < this.viewportMinimum) break;
        ...
        D.prototype.renderInterlacedColors = function () {
            ...
            d = !0;
            if (("bottom" === this._position || "top" === this._position) && this.interlacedColor) for (a.fillStyle =
            ...
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, c, b = 0, e = 0, f = !1, k = !1, l = [], m = [], k = !1, b = 0; b < this.stripLines.length; b++) {
                    ...
                    h._thicknessType === a && ("pixel" === a && (h.value < this.viewportMinimum ||
                        h.value > this.viewportMaximum || t(h.value) || isNaN(this.range)) || l.push(h))
                }
        ...
        D.prototype.createMask = function () {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                s ? (this.maskCanvas = sa(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas =
        ...
        D.prototype.showCrosshair = function (a) {
            t(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position || "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a), null, a) : this.crosshair.render(null, this.convertValueToPixel(a), a))
        };
        D.prototype.renderGrid = function () {
            if (this.gridThickness && 0 < this.gridThickness) {
                ...
                if ("bottom" === this._position || "top" === this._position) for (b = 0; b < this._labels.length; b++) this._labels[b].position < this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[b].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) +
        ...
        D.prototype.renderAxisLine = function () {
            var a =
                    this.chart.ctx, d = s ? this.chart._preRenderCtx : a,
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    d.beginPath();
                    if (this.scaleBreaks && !t(this.scaleBreaks.firstBreakIndex)) if (t(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b; else for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(e, k), d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + c, k), e = this.scaleBreaks._appliedBreaks[l].endPixel + b;
                    e && (d.moveTo(e,
                        k), d.lineTo(f, k));
                    d.stroke()
                }
                ...
                d.beginPath();
                if (this.scaleBreaks && !t(this.scaleBreaks.firstBreakIndex)) if (t(this.scaleBreaks.lastBreakIndex)) e =
                    this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c; else for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(k, e), d.lineTo(k, this.scaleBreaks._appliedBreaks[l].startPixel + b), e = this.scaleBreaks._appliedBreaks[l].endPixel + c;
                e && (d.moveTo(k, e), d.lineTo(k, f));
                d.stroke()
            }
            s && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), this.chart._breaksCanvasCtx && this.chart._breaksCanvasCtx.drawImage(this.chart._preRenderCanvas,
        ...
        D.prototype.convertPixelToValue = function (a) {
            ...
            if (this.logarithmic) {
                ...
                if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !==
                    ...
                    e[c].startValue) / (e[c].endValue - e[c].startValue), b += e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), d = !1; else if (b < e[c].endValue - this.conversionParameters.minimum) {
                    b -= e[c].endValue - this.conversionParameters.minimum;
                    if (b > -1 * e[c].size) {
                        a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) + b;
                        break
        ...
        D.prototype.getApparentDifference = function (a, d, c, b) {
            ...
            } else for (c = t(c) ? Math.abs(d - a) : c, f = 0; f < e.length &&
        ...
        D.prototype.calculateValueToPixelConversionParameters = function (a) {
            ...
            if (this.logarithmic) for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ?
        ...
        D.prototype.calculateAxisParameters = function () {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
                ...
                !t(this.options.viewportMinimum) && (!t(this.options.viewportMaximum) && this.options.viewportMinimum >= this.options.viewportMaximum) && (this.viewportMinimum = this.viewportMaximum = null);
                if (t(this.options.viewportMinimum) && !t(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum =
                    this.sessionVariables.newViewportMinimum; else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
                if (t(this.options.viewportMaximum) && !t(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum)) this.viewportMaximum = this.sessionVariables.newViewportMaximum; else if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum;
                if (this.scaleBreaks) for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++) if ((!t(this.sessionVariables.newViewportMinimum) &&
                    ...
                    !t(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue)) {
                ...
                t(this.sessionVariables.newViewportMinimum) && (this.viewportMinimum = Math.max(this.viewportMinimum, this.minimum));
                t(this.sessionVariables.newViewportMaximum) && (this.viewportMaximum = Math.min(this.viewportMaximum, this.maximum));
        ...
        D.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            if (this.scaleBreaks) for (k =
                ...
                !t(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[k].endValue || !t(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue)) {
        ...
        U.prototype.render = function (a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === r % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + r / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = {
                    x1: b - r / 2,
                    y1: e,
                    x2: k + r / 2,
                    y2: l
                }, this.ctx.moveTo(b,
                    e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(k, l), this.ctx.lineTo(k, e); else if ("wavy" === this.type) {
                    m = b;
                    h = e;
                    f = 0.5;
                    n = (l - h) / a / 3;
        ...
        aa.prototype.showAt = function (a) {
            ...
            for (b = 0; b < d.axisX.length; b++) a = d.axisX[b]._crosshairValue, d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !t(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a), d.axisX[b].crosshair._updatedValue = a, this === d.axisX[b].crosshair && (c = !0));
            for (b = 0; b < d.axisX2.length; b++) a = d.axisX2[b]._crosshairValue, d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !t(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) &&
            (d.axisX2[b].showCrosshair(a), d.axisX2[b].crosshair._updatedValue = a, this === d.axisX2[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY.length; b++) a = d.axisY[b]._crosshairValue, d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !t(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a), d.axisY[b].crosshair._updatedValue = a, this === d.axisY[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY2.length; b++) a = d.axisY2[b]._crosshairValue, d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled &&
                !t(a) && d._crosshairY2Value >= d.axisY2[b].viewportMinimum && d._crosshairY2Value <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a), d.axisY2[b].crosshair._updatedValue = a, this === d.axisY2[b].crosshair && (c = !0));
        ...
        aa.prototype.render = function (a, d, c) {
            ...
            q.lineWidth = r;
            q.save();
            this.labelFontSize = t(this.options.labelFontSize) ? this.parent.labelFontSize : this.labelFontSize;
            this.labelMaxWidth = t(this.options.labelMaxWidth) ?
                0.3 * this.chart.width : this.labelMaxWidth;
            this.labelMaxHeight = t(this.options.labelWrap) || this.labelWrap ? 0.3 * this.chart.height : 2 * this.labelFontSize;
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var v = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) s = this.parent.dataSeries[0].axisX.convertPixelToValue({y: d}); else if ("left" === this.parent._position || "right" === this.parent._position) s =
                        this.parent.convertPixelToValue({y: d});
                    for (var w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
                    v = null;
                    ...
                    w = 0;
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])),
                                                                                                          u = 0, s = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (var x = 0; x < n[s].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)), u < v && (v = u, w = s); else if ("stackedBar" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), E = u = 0, s = w = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (x = 0; x < n[s].dataPoint.y.length; x++) u =
                        Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else E += n[s].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(E)), u < v && (v = u, w = s); else if ("stackedBar100" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = E = u = 0, s = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (x = 0; x < n[s].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else E += n[s].dataPoint.y,
                        C = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, C = 100 * (E / n[s].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, w = s); else for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = w = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (x = 0; x < n[s].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)),
                    u < v && (v = u, w = s);
                    x = n[w];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            for (s = u = 0; s < x.dataPoint.y.length; s++) u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[s])), u < v && (v = u, b = s);
                            ...
                            h.text =
                                ...
                                }) : t(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar" === this.parent.dataSeries[w].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            E = u = 0;
                            for (s = w; 0 <= s; s--) E += n[s].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(E)), u < v && (v = u, b = s);
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(E) <<
                                0) + 0.5 : this.parent.convertValueToPixel(E) << 0;
                            h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: c ? c : x.dataPoint.y
                            }) : t(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[w].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            C = E = u = 0;
                            for (s = w; 0 <= s; s--) E += n[s].dataPoint.y, C = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() :
                                n[s].dataPoint.x, C = 100 * (E / n[s].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, b = s);
                            ...
                            h.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: c ? c : C
                            }) : t(this.options.label) ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo) : this.label
                        ...
                        C = !1;
                        if (this.parent.labels) for (n =
                                                         Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += n) if (this.parent.labels[s]) C = !0; else {
                            C = !1;
                            break
                        }
                        if (C) {
                            if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({y: d}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                            }) : t(this.options.label) ? v.dataPoint.label : this.label)
                        } else "dateTime" ===
                        ...
                        }) : t(this.options.label) ? za(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : x.dataPoint.x
                        }) : t(this.options.label) ? ea(c ? c : x.dataPoint.x, this.valueFormatString,
                    ...
                    for (w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
                    if (0 === n.length) return;
                    n.sort(function (a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    this.bounds = {x1: b - r / 2, y1: f, x2: e + r / 2, y2: k};
                    C = !1;
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += n) if (this.parent.labels[s]) C = !0; else {
                        C = !1;
                        break
                    }
                    if (C) {
                    ...
                    !t(this.parent.dataSeries) &&
                    0 < this.parent.dataSeries.length && (s = this.parent.dataSeries[0].axisX.convertPixelToValue({x: a}));
                    for (w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
                    if (0 === n.length) return;
                    n.sort(function (a, b) {
                        return a.distance - b.distance
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" ===
                        n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), s = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (x = 0; x < n[s].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y)), u < v && (v = u, w = s); else if ("stackedColumn" === n[0].dataSeries.type ||
                        "stackedArea" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = E = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (x = 0; x < n[s].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else E += n[s].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(E)), u < v && (v = u, w = s); else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   s = C = E = u = 0; s < n.length; s++) if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (x = 0; x < n[s].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else E += n[s].dataPoint.y, C = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, C = 100 * (E / n[s].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, w = s); else for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = u = 0; s < n.length; s++) if (n[s].dataPoint.y &&
                        n[s].dataPoint.y.length) for (x = 0; x < n[s].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[x])), u < v && (v = u, w = s); else u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y)), u < v && (v = u, w = s);
                    x = n[w];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type ||
                        ...
                        for (s = u = 0; s < x.dataPoint.y.length; s++) u = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[s])), u < v && (v = u, b = s);
                        ...
                        E = u = 0;
                        for (s = w; 0 <= s; s--) E += n[s].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(E)), u < v && (v = u, b = s);
                        m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(E) << 0) + 0.5 : this.parent.convertValueToPixel(E) <<
                            0;
                        h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
                        E = u = 0;
                        for (s = w; 0 <= s; s--) E += n[s].dataPoint.y, C = n[s].dataPoint.x.getTime ?
                            n[s].dataPoint.x.getTime() : n[s].dataPoint.x, C = 100 * (E / n[s].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, b = s);
                    ...
                    this.parent.dataSeries[w].type ? (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum
                    }) : t(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString,
                        this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (m = 1 === q.lineWidth % 2 ? (t(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : t(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: x.dataPoint.y
                    }) : t(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataPoint.y);
                    f = k = m;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = {x1: b, y1: f - r / 2, x2: e, y2: k + r / 2};
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - h.fontSize / 2 + h.measureText().height > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2), b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.reversed ?
                    this.parent.viewportMinimum : this.parent.viewportMaximum) && (0 < r && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), this._hidden = !1), q.restore(), !t(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
                if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "right" === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.measureText().width), k >= this.parent.convertValueToPixel(this.parent.reversed ?
                    this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < r && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), this._hidden = !1), q.restore(), !t(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0))
            } else {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                    ...
                    if (C) {
                        if ("axisX" ===
                            this.parent.type) for (s = this.parent.convertPixelToValue({y: d}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                    ...
                    }) : t(this.options.label) ? za(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: c ? c : this.parent.convertPixelToValue(d)
                    }) : t(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) h.text = this.labelFormatter ?
                        this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                        }) : t(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label, h.x = b - h.measureText().width / 2, h.x + h.width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.width), h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "bottom" === this.parent._position ? h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2 : "top" === this.parent._position &&
                    ...
                    if (C) {
                        if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({x: a}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ?
                            this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: c ? c : this.parent.convertPixelToValue(a)
                            }) : t(this.options.label) ? c ? c : v.dataPoint.label : this.label)
                    } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                        }) : t(this.options.label) ? za(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label :
                        ...
                        }) : t(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    h.x = b - h.measureText().width / 2;
                    h.x + h.width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.width);
                    h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1);
                    "bottom" === this.parent._position ? h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2 : "top" === this.parent._position && (h.y = this.parent.lineCoordinates.y1 - h.height + h.fontSize / 2 + 2)
                    ...
                    crosshair: this.options,
                    value: c ? c : this.parent.convertPixelToValue(d)
                }) : t(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                ...
                q.restore();
                !t(h.text) && ("number" === typeof h.text.valueOf() ||
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        l = [];
                        if (this.chart.axisX) for (m = 0; m < this.chart.axisX.length; m++) for (k = this.chart.axisX[m].convertPixelToValue({x: a}), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++) (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k,
                            c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
                        if (this.chart.axisX2) for (m = 0; m < this.chart.axisX2.length; m++) for (k = this.chart.axisX2[m].convertPixelToValue({x: a}), h = null, b = 0; b < this.chart.axisX2[m].dataSeries.length; b++) (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && l.push(h))
                    }
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex = h.dataSeries.index; else if (s) if (h = Xa(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) {
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], h.dataSeries = e, h.dataPoint = b, h.index = this.currentDataPointIndex, h.distance = Math.abs(b.x - k), "waterfall" === e.type && (h.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, h.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                            ...
                            t(h) || (h.dataSeries = e, this.currentDataPointIndex = h.index, b = h.dataPoint)
                        }
                        if (!t(h) && !t(h.dataPoint) && !t(h.dataPoint.y)) if (h.dataSeries.axisY) if (0 <
        ...
        $.prototype.highlightObjects = function (a) {
            ...
            if (t(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas) this.chart.resetOverlayedCanvas(), d.clearRect(0, 0, this.chart.width, this.chart.height), this.chart.clearedOverlayedCanvas = "toolTip";
            d.save();
        ...
        $.prototype.showAtX = function (a, d) {
            ...
            var c, b, e, f = [];
            e = !1;
            d = !t(d) && 0 <= d && d < this.chart.data.length ? d : 0;
            if (this.shared) for (var k = 0; k < this.chart.data.length; k++) c = this.chart.data[k], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !t(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b)); else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !t(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            if (0 < f.length) {
