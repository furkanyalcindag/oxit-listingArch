;(function (global, factory) {
    ...
    hooks.createFromInputFallback = deprecate(
        'value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to scripts Date(), ' +
    ...
    // ASP.NET jsons date format regex
    ...
    //! moment.scripts locale configuration
    ...
    //! moment.scripts language configuration
