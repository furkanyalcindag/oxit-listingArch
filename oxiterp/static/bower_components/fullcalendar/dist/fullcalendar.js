...
function oldMomentFormat(mom, formatStr) {
    return oldMomentProto.format.call(mom, formatStr); // oldMomentProto defined in moment-ext.scripts
}
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        if (this.cellWeekNumbersVisible) {
            ...
            // rely on moment.scripts methods such as firstDayOfWeek() or weekday(),
...
var Popover = /** @class */ (function () {
    ...
    // Triggered when the user clicks *anywhere* in the document, for the autoHide option
